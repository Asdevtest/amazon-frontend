...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new Amazonapi.InlineObject1();
      //expect(instance).to.be.a(Amazonapi.InlineObject1);
    });

    it('should have the property guids (base name: "guids")', function() {
      // uncomment below and update the code to test the property guids
      //var instance = new Amazonapi.InlineObject1();
