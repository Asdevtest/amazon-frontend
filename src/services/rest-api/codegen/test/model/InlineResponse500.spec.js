...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse500();
  });
  ...
  describe('InlineResponse500', function() {
    it('should create an instance of InlineResponse500', function() {
      ...
      //var instane = new Amazonapi.InlineResponse500();
      //expect(instance).to.be.a(Amazonapi.InlineResponse500);
    });

    it('should have the property statusCode (base name: "statusCode")', function() {
      // uncomment below and update the code to test the property statusCode
      //var instance = new Amazonapi.InlineResponse500();
