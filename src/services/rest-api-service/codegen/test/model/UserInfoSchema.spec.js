...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.UserInfoSchema();
  });
  ...
  describe('UserInfoSchema', function() {
    it('should create an instance of UserInfoSchema', function() {
      // uncomment below and update the code to test UserInfoSchema
      //var instane = new TestSwagger.UserInfoSchema();
      //expect(instance).to.be.a(TestSwagger.UserInfoSchema);
    });
