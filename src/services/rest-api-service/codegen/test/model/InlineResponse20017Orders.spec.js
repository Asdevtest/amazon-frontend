...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20017Orders();
  });
  ...
  describe('InlineResponse20017Orders', function() {
    it('should create an instance of InlineResponse20017Orders', function() {
      // uncomment below and update the code to test InlineResponse20017Orders
      //var instane = new TestSwagger.InlineResponse20017Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20017Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20017Orders();
