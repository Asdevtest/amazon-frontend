...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20031Details();
  });
  ...
  describe('InlineResponse20031Details', function() {
    it('should create an instance of InlineResponse20031Details', function() {
      // uncomment below and update the code to test InlineResponse20031Details
      //var instane = new TestSwagger.InlineResponse20031Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20031Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20031Details();
