...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new TestSwagger.InlineObject3();
      //expect(instance).to.be.a(TestSwagger.InlineObject3);
    });

    it('should have the property productId (base name: "productId")', function() {
      // uncomment below and update the code to test the property productId
      //var instance = new TestSwagger.InlineObject3();
