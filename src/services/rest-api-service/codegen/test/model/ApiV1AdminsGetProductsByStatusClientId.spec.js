...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsGetProductsByStatusClientId();
  });
  ...
  describe('ApiV1AdminsGetProductsByStatusClientId', function() {
    it('should create an instance of ApiV1AdminsGetProductsByStatusClientId', function() {
      // uncomment below and update the code to test ApiV1AdminsGetProductsByStatusClientId
      //var instane = new Amazonapi.ApiV1AdminsGetProductsByStatusClientId();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsGetProductsByStatusClientId);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.ApiV1AdminsGetProductsByStatusClientId();
