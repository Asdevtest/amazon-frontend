...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20036Details();
  });
  ...
  describe('InlineResponse20036Details', function() {
    it('should create an instance of InlineResponse20036Details', function() {
      // uncomment below and update the code to test InlineResponse20036Details
      //var instane = new TestSwagger.InlineResponse20036Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20036Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20036Details();
