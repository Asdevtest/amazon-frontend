...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject34();
  });
  ...
  describe('InlineObject34', function() {
    it('should create an instance of InlineObject34', function() {
      ...
      //var instane = new TestSwagger.InlineObject34();
      //expect(instance).to.be.a(TestSwagger.InlineObject34);
    });
    ...
    it('should have the property taskId (base name: "taskId")', function() {
      ...
      //var instance = new TestSwagger.InlineObject34();
