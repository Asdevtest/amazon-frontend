...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1ShopSellStatistics();
  });
  ...
  describe('ApiV1ShopSellStatistics', function() {
    it('should create an instance of ApiV1ShopSellStatistics', function() {
      // uncomment below and update the code to test ApiV1ShopSellStatistics
      //var instane = new TestSwagger.ApiV1ShopSellStatistics();
