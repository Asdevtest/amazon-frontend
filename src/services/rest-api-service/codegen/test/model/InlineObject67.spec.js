...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject67();
  });
  ...
  describe('InlineObject67', function() {
    it('should create an instance of InlineObject67', function() {
      ...
      //var instane = new TestSwagger.InlineObject67();
      //expect(instance).to.be.a(TestSwagger.InlineObject67);
    });

    it('should have the property text (base name: "text")', function() {
      // uncomment below and update the code to test the property text
      //var instance = new TestSwagger.InlineObject67();
