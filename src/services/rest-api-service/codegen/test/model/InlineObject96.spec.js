...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject96();
  });
  ...
  describe('InlineObject96', function() {
    it('should create an instance of InlineObject96', function() {
      ...
      //var instane = new TestSwagger.InlineObject96();
      //expect(instance).to.be.a(TestSwagger.InlineObject96);
    });
    ...
    it('should have the property request (base name: "request")', function() {
      ...
      //var instance = new TestSwagger.InlineObject96();
