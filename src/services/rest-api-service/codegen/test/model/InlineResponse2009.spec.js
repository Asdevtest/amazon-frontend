...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2009();
  });
  ...
  describe('InlineResponse2009', function() {
    it('should create an instance of InlineResponse2009', function() {
      ...
      //var instane = new TestSwagger.InlineResponse2009();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2009);
    });

    it('should have the property count (base name: "count")', function() {
      // uncomment below and update the code to test the property count
      //var instance = new TestSwagger.InlineResponse2009();
