...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20052Details();
  });
  ...
  describe('InlineResponse20052Details', function() {
    it('should create an instance of InlineResponse20052Details', function() {
      // uncomment below and update the code to test InlineResponse20052Details
      //var instane = new TestSwagger.InlineResponse20052Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20052Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20052Details();
