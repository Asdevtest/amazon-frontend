...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20018Details();
  });
  ...
  describe('InlineResponse20018Details', function() {
    it('should create an instance of InlineResponse20018Details', function() {
      // uncomment below and update the code to test InlineResponse20018Details
      //var instane = new TestSwagger.InlineResponse20018Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20018Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20018Details();
