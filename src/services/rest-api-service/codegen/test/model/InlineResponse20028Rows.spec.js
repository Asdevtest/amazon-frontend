...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20028Rows();
  });
  ...
  describe('InlineResponse20028Rows', function() {
    it('should create an instance of InlineResponse20028Rows', function() {
      // uncomment below and update the code to test InlineResponse20028Rows
      //var instane = new TestSwagger.InlineResponse20028Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20028Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20028Rows();
    ...
    it('should have the property ideasCounter (base name: "ideasCounter")', function() {
      // uncomment below and update the code to test the property ideasCounter
      //var instance = new TestSwagger.InlineResponse20028Rows();
      //expect(instance).to.be();
    });
