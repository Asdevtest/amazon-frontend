...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject13();
  });
  ...
  describe('InlineObject13', function() {
    it('should create an instance of InlineObject13', function() {
      ...
      //var instane = new Amazonapi.InlineObject13();
      //expect(instance).to.be.a(Amazonapi.InlineObject13);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Amazonapi.InlineObject13();
