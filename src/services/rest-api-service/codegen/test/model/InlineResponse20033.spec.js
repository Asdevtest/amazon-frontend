...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20033();
  });
  ...
  describe('InlineResponse20033', function() {
    it('should create an instance of InlineResponse20033', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20033();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20033);
    });

    it('should have the property tasks (base name: "tasks")', function() {
      // uncomment below and update the code to test the property tasks
      //var instance = new TestSwagger.InlineResponse20033();
