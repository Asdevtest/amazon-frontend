...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject86();
  });
  ...
  describe('InlineObject86', function() {
    it('should create an instance of InlineObject86', function() {
      // uncomment below and update the code to test InlineObject86
      //var instane = new TestSwagger.InlineObject86();
      //expect(instance).to.be.a(TestSwagger.InlineObject86);
    });

    it('should have the property category (base name: "category")', function() {
      // uncomment below and update the code to test the property category
      //var instance = new TestSwagger.InlineObject86();
