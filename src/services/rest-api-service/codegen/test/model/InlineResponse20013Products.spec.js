...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20013Products();
  });
  ...
  describe('InlineResponse20013Products', function() {
    it('should create an instance of InlineResponse20013Products', function() {
      // uncomment below and update the code to test InlineResponse20013Products
      //var instane = new TestSwagger.InlineResponse20013Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20013Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20013Products();
