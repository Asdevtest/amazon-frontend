...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsTasksBoxesBefore();
  });
  ...
  describe('ApiV1AdminsTasksBoxesBefore', function() {
    it('should create an instance of ApiV1AdminsTasksBoxesBefore', function() {
      // uncomment below and update the code to test ApiV1AdminsTasksBoxesBefore
      //var instane = new Amazonapi.ApiV1AdminsTasksBoxesBefore();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsTasksBoxesBefore);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Amazonapi.ApiV1AdminsTasksBoxesBefore();
