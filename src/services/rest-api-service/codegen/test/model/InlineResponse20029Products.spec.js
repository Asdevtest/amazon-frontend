...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20029Products();
  });
  ...
  describe('InlineResponse20029Products', function() {
    it('should create an instance of InlineResponse20029Products', function() {
      // uncomment below and update the code to test InlineResponse20029Products
      //var instane = new TestSwagger.InlineResponse20029Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20029Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20029Products();
