...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20026Orders();
  });
  ...
  describe('InlineResponse20026Orders', function() {
    it('should create an instance of InlineResponse20026Orders', function() {
      // uncomment below and update the code to test InlineResponse20026Orders
      //var instane = new TestSwagger.InlineResponse20026Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20026Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20026Orders();
