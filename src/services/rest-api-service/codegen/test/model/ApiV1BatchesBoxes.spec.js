...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BatchesBoxes();
  });
  ...
  describe('ApiV1BatchesBoxes', function() {
    it('should create an instance of ApiV1BatchesBoxes', function() {
      // uncomment below and update the code to test ApiV1BatchesBoxes
      //var instane = new TestSwagger.ApiV1BatchesBoxes();
      //expect(instance).to.be.a(TestSwagger.ApiV1BatchesBoxes);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.ApiV1BatchesBoxes();
    ...
    it('should have the property deliveryTotalPrice (base name: "deliveryTotalPrice")', function() {
      // uncomment below and update the code to test the property deliveryTotalPrice
      //var instance = new TestSwagger.ApiV1BatchesBoxes();
      //expect(instance).to.be();
    });

    it('should have the property deliveryTotalPriceChanged (base name: "deliveryTotalPriceChanged")', function() {
      // uncomment below and update the code to test the property deliveryTotalPriceChanged
      //var instance = new TestSwagger.ApiV1BatchesBoxes();
      //expect(instance).to.be();
    });
