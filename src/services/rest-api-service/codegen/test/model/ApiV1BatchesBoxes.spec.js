...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1BatchesBoxes();
  });
  ...
  describe('ApiV1BatchesBoxes', function() {
    it('should create an instance of ApiV1BatchesBoxes', function() {
      ...
      //var instane = new Amazonapi.ApiV1BatchesBoxes();
      //expect(instance).to.be.a(Amazonapi.ApiV1BatchesBoxes);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.ApiV1BatchesBoxes();
