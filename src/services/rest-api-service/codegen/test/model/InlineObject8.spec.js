...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject8();
  });
  ...
  describe('InlineObject8', function() {
    it('should create an instance of InlineObject8', function() {
      ...
      //var instane = new Amazonapi.InlineObject8();
      //expect(instance).to.be.a(Amazonapi.InlineObject8);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new Amazonapi.InlineObject8();
