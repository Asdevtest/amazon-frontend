...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20028Products();
  });
  ...
  describe('InlineResponse20028Products', function() {
    it('should create an instance of InlineResponse20028Products', function() {
      // uncomment below and update the code to test InlineResponse20028Products
      //var instane = new TestSwagger.InlineResponse20028Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20028Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20028Products();
