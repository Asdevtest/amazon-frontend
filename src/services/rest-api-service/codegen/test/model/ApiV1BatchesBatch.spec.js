...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1BatchesBatch();
  });
  ...
  describe('ApiV1BatchesBatch', function() {
    it('should create an instance of ApiV1BatchesBatch', function() {
      ...
      //var instane = new Amazonapi.ApiV1BatchesBatch();
      //expect(instance).to.be.a(Amazonapi.ApiV1BatchesBatch);
    });
    ...
    it('should have the property deliveryMethod (base name: "deliveryMethod")', function() {
      ...
      //var instance = new Amazonapi.ApiV1BatchesBatch();
