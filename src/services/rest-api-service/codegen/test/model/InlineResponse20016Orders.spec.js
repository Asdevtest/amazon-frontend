...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20016Orders();
  });
  ...
  describe('InlineResponse20016Orders', function() {
    it('should create an instance of InlineResponse20016Orders', function() {
      // uncomment below and update the code to test InlineResponse20016Orders
      //var instane = new TestSwagger.InlineResponse20016Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20016Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20016Orders();
