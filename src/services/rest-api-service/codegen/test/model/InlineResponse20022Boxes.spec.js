...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20022Boxes();
  });
  ...
  describe('InlineResponse20022Boxes', function() {
    it('should create an instance of InlineResponse20022Boxes', function() {
      // uncomment below and update the code to test InlineResponse20022Boxes
      //var instane = new TestSwagger.InlineResponse20022Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20022Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20022Boxes();
