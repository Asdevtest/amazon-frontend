...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20026Rows();
  });
  ...
  describe('InlineResponse20026Rows', function() {
    it('should create an instance of InlineResponse20026Rows', function() {
      // uncomment below and update the code to test InlineResponse20026Rows
      //var instane = new TestSwagger.InlineResponse20026Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20026Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20026Rows();
