...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsGetProductsByStatusClient();
  });
  ...
  describe('ApiV1AdminsGetProductsByStatusClient', function() {
    it('should create an instance of ApiV1AdminsGetProductsByStatusClient', function() {
      // uncomment below and update the code to test ApiV1AdminsGetProductsByStatusClient
      //var instane = new Amazonapi.ApiV1AdminsGetProductsByStatusClient();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsGetProductsByStatusClient);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.ApiV1AdminsGetProductsByStatusClient();
