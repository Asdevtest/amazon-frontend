...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20015Orders();
  });
  ...
  describe('InlineResponse20015Orders', function() {
    it('should create an instance of InlineResponse20015Orders', function() {
      // uncomment below and update the code to test InlineResponse20015Orders
      //var instane = new TestSwagger.InlineResponse20015Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20015Orders);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20015Orders();
