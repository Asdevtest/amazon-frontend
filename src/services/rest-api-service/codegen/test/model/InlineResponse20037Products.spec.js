...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20037Products();
  });
  ...
  describe('InlineResponse20037Products', function() {
    it('should create an instance of InlineResponse20037Products', function() {
      // uncomment below and update the code to test InlineResponse20037Products
      //var instane = new TestSwagger.InlineResponse20037Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20037Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20037Products();
