...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20020Products();
  });
  ...
  describe('InlineResponse20020Products', function() {
    it('should create an instance of InlineResponse20020Products', function() {
      // uncomment below and update the code to test InlineResponse20020Products
      //var instane = new TestSwagger.InlineResponse20020Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20020Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20020Products();
