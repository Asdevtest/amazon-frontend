...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20029Orders();
  });
  ...
  describe('InlineResponse20029Orders', function() {
    it('should create an instance of InlineResponse20029Orders', function() {
      // uncomment below and update the code to test InlineResponse20029Orders
      //var instane = new TestSwagger.InlineResponse20029Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20029Orders);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20029Orders();
