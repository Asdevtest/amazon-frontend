...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20030Rows();
  });
  ...
  describe('InlineResponse20030Rows', function() {
    it('should create an instance of InlineResponse20030Rows', function() {
      // uncomment below and update the code to test InlineResponse20030Rows
      //var instane = new TestSwagger.InlineResponse20030Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20030Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20030Rows();
