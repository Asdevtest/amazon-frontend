...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject77();
  });
  ...
  describe('InlineObject77', function() {
    it('should create an instance of InlineObject77', function() {
      // uncomment below and update the code to test InlineObject77
      //var instane = new TestSwagger.InlineObject77();
