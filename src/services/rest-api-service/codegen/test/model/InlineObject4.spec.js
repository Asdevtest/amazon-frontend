...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new TestSwagger.InlineObject4();
      //expect(instance).to.be.a(TestSwagger.InlineObject4);
    });

    it('should have the property guids (base name: "guids")', function() {
      // uncomment below and update the code to test the property guids
      //var instance = new TestSwagger.InlineObject4();
