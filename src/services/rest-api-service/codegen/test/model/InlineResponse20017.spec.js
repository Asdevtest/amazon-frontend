...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20017();
  });
  ...
  describe('InlineResponse20017', function() {
    it('should create an instance of InlineResponse20017', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20017();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20017);
    });

    it('should have the property rows (base name: "rows")', function() {
      // uncomment below and update the code to test the property rows
      //var instance = new TestSwagger.InlineResponse20017();
