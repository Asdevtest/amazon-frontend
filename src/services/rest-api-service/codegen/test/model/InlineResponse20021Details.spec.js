...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Details();
  });
  ...
  describe('InlineResponse20021Details', function() {
    it('should create an instance of InlineResponse20021Details', function() {
      // uncomment below and update the code to test InlineResponse20021Details
      //var instane = new TestSwagger.InlineResponse20021Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20021Details();
