...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsRequest();
  });
  ...
  describe('ApiV1RequestsRequest', function() {
    it('should create an instance of ApiV1RequestsRequest', function() {
      // uncomment below and update the code to test ApiV1RequestsRequest
      //var instane = new TestSwagger.ApiV1RequestsRequest();
      //expect(instance).to.be.a(TestSwagger.ApiV1RequestsRequest);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.ApiV1RequestsRequest();
