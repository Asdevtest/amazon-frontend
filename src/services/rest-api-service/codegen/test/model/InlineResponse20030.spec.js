...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20030();
  });
  ...
  describe('InlineResponse20030', function() {
    it('should create an instance of InlineResponse20030', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20030();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20030);
    });
    ...
    it('should have the property priceForClient (base name: "priceForClient")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20030();
