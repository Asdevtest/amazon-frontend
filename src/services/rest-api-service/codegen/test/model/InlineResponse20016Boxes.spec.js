...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20016Boxes();
  });
  ...
  describe('InlineResponse20016Boxes', function() {
    it('should create an instance of InlineResponse20016Boxes', function() {
      // uncomment below and update the code to test InlineResponse20016Boxes
      //var instane = new TestSwagger.InlineResponse20016Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20016Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20016Boxes();
