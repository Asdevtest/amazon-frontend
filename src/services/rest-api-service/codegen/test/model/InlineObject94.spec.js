...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject94();
  });
  ...
  describe('InlineObject94', function() {
    it('should create an instance of InlineObject94', function() {
      // uncomment below and update the code to test InlineObject94
      //var instane = new TestSwagger.InlineObject94();
