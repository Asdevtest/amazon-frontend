...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.BadRequestError();
  });
  ...
  describe('BadRequestError', function() {
    it('should create an instance of BadRequestError', function() {
      ...
      //var instane = new Amazonapi.BadRequestError();
      //expect(instance).to.be.a(Amazonapi.BadRequestError);
    });

    it('should have the property statusCode (base name: "statusCode")', function() {
      // uncomment below and update the code to test the property statusCode
      //var instance = new Amazonapi.BadRequestError();
