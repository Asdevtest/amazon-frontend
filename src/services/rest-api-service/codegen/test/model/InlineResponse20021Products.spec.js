...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Products();
  });
  ...
  describe('InlineResponse20021Products', function() {
    it('should create an instance of InlineResponse20021Products', function() {
      // uncomment below and update the code to test InlineResponse20021Products
      //var instane = new TestSwagger.InlineResponse20021Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20021Products();
