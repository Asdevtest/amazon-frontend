...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20014Details();
  });
  ...
  describe('InlineResponse20014Details', function() {
    it('should create an instance of InlineResponse20014Details', function() {
      // uncomment below and update the code to test InlineResponse20014Details
      //var instane = new TestSwagger.InlineResponse20014Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20014Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20014Details();
