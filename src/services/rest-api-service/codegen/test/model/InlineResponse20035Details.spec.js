...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20035Details();
  });
  ...
  describe('InlineResponse20035Details', function() {
    it('should create an instance of InlineResponse20035Details', function() {
      // uncomment below and update the code to test InlineResponse20035Details
      //var instane = new TestSwagger.InlineResponse20035Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20035Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20035Details();
