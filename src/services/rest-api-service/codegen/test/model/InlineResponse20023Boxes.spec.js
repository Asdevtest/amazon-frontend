...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20023Boxes();
  });
  ...
  describe('InlineResponse20023Boxes', function() {
    it('should create an instance of InlineResponse20023Boxes', function() {
      // uncomment below and update the code to test InlineResponse20023Boxes
      //var instane = new TestSwagger.InlineResponse20023Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20023Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20023Boxes();
