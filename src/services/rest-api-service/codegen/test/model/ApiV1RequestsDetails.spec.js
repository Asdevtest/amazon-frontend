...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsDetails();
  });
  ...
  describe('ApiV1RequestsDetails', function() {
    it('should create an instance of ApiV1RequestsDetails', function() {
      // uncomment below and update the code to test ApiV1RequestsDetails
      //var instane = new TestSwagger.ApiV1RequestsDetails();
      //expect(instance).to.be.a(TestSwagger.ApiV1RequestsDetails);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.ApiV1RequestsDetails();
