...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20010();
  });
  ...
  describe('InlineResponse20010', function() {
    it('should create an instance of InlineResponse20010', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20010();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20010);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new TestSwagger.InlineResponse20010();
