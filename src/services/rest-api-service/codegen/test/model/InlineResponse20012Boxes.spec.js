...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20012Boxes();
  });
  ...
  describe('InlineResponse20012Boxes', function() {
    it('should create an instance of InlineResponse20012Boxes', function() {
      // uncomment below and update the code to test InlineResponse20012Boxes
      //var instane = new TestSwagger.InlineResponse20012Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20012Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20012Boxes();
