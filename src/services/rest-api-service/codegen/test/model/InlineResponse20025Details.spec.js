...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20025Details();
  });
  ...
  describe('InlineResponse20025Details', function() {
    it('should create an instance of InlineResponse20025Details', function() {
      // uncomment below and update the code to test InlineResponse20025Details
      //var instane = new TestSwagger.InlineResponse20025Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20025Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20025Details();
