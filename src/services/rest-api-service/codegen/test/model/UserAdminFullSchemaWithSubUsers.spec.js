...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.UserAdminFullSchemaWithSubUsers();
  });
  ...
  describe('UserAdminFullSchemaWithSubUsers', function() {
    it('should create an instance of UserAdminFullSchemaWithSubUsers', function() {
      // uncomment below and update the code to test UserAdminFullSchemaWithSubUsers
      //var instane = new TestSwagger.UserAdminFullSchemaWithSubUsers();
      //expect(instance).to.be.a(TestSwagger.UserAdminFullSchemaWithSubUsers);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.UserAdminFullSchemaWithSubUsers();
