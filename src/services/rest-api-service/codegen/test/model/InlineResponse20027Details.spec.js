...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20027Details();
  });
  ...
  describe('InlineResponse20027Details', function() {
    it('should create an instance of InlineResponse20027Details', function() {
      // uncomment below and update the code to test InlineResponse20027Details
      //var instane = new TestSwagger.InlineResponse20027Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20027Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20027Details();
