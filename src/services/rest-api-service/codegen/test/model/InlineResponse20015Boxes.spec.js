...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20015Boxes();
  });
  ...
  describe('InlineResponse20015Boxes', function() {
    it('should create an instance of InlineResponse20015Boxes', function() {
      // uncomment below and update the code to test InlineResponse20015Boxes
      //var instane = new TestSwagger.InlineResponse20015Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20015Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20015Boxes();
