...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20033Details();
  });
  ...
  describe('InlineResponse20033Details', function() {
    it('should create an instance of InlineResponse20033Details', function() {
      // uncomment below and update the code to test InlineResponse20033Details
      //var instane = new TestSwagger.InlineResponse20033Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20033Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20033Details();
