...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20063Details();
  });
  ...
  describe('InlineResponse20063Details', function() {
    it('should create an instance of InlineResponse20063Details', function() {
      // uncomment below and update the code to test InlineResponse20063Details
      //var instane = new TestSwagger.InlineResponse20063Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20063Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20063Details();
