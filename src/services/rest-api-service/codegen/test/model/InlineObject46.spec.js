...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject46();
  });
  ...
  describe('InlineObject46', function() {
    it('should create an instance of InlineObject46', function() {
      ...
      //var instane = new TestSwagger.InlineObject46();
      //expect(instance).to.be.a(TestSwagger.InlineObject46);
    });
    ...
    it('should have the property clientComment (base name: "clientComment")', function() {
      ...
      //var instance = new TestSwagger.InlineObject46();
