...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20012Orders();
  });
  ...
  describe('InlineResponse20012Orders', function() {
    it('should create an instance of InlineResponse20012Orders', function() {
      // uncomment below and update the code to test InlineResponse20012Orders
      //var instane = new TestSwagger.InlineResponse20012Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20012Orders);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20012Orders();
