...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20012Details();
  });
  ...
  describe('InlineResponse20012Details', function() {
    it('should create an instance of InlineResponse20012Details', function() {
      // uncomment below and update the code to test InlineResponse20012Details
      //var instane = new TestSwagger.InlineResponse20012Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20012Details);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20012Details();
