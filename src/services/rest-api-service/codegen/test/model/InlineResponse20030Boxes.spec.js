...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20030Boxes();
  });
  ...
  describe('InlineResponse20030Boxes', function() {
    it('should create an instance of InlineResponse20030Boxes', function() {
      // uncomment below and update the code to test InlineResponse20030Boxes
      //var instane = new TestSwagger.InlineResponse20030Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20030Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20030Boxes();
