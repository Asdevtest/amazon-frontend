...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20022Orders();
  });
  ...
  describe('InlineResponse20022Orders', function() {
    it('should create an instance of InlineResponse20022Orders', function() {
      // uncomment below and update the code to test InlineResponse20022Orders
      //var instane = new TestSwagger.InlineResponse20022Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20022Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20022Orders();
