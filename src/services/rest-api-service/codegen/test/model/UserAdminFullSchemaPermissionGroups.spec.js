...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.UserAdminFullSchemaPermissionGroups();
  });
  ...
  describe('UserAdminFullSchemaPermissionGroups', function() {
    it('should create an instance of UserAdminFullSchemaPermissionGroups', function() {
      // uncomment below and update the code to test UserAdminFullSchemaPermissionGroups
      //var instane = new TestSwagger.UserAdminFullSchemaPermissionGroups();
      //expect(instance).to.be.a(TestSwagger.UserAdminFullSchemaPermissionGroups);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.UserAdminFullSchemaPermissionGroups();
