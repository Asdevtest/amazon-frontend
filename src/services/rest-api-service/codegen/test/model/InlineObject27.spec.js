...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject27();
  });
  ...
  describe('InlineObject27', function() {
    it('should create an instance of InlineObject27', function() {
      ...
      //var instane = new Amazonapi.InlineObject27();
      //expect(instance).to.be.a(Amazonapi.InlineObject27);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new Amazonapi.InlineObject27();
