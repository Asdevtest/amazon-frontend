...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20039Details();
  });
  ...
  describe('InlineResponse20039Details', function() {
    it('should create an instance of InlineResponse20039Details', function() {
      // uncomment below and update the code to test InlineResponse20039Details
      //var instane = new TestSwagger.InlineResponse20039Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20039Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20039Details();
