...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1BoxesMergeBoxBody();
  });
  ...
  describe('ApiV1BoxesMergeBoxBody', function() {
    it('should create an instance of ApiV1BoxesMergeBoxBody', function() {
      ...
      //var instane = new Amazonapi.ApiV1BoxesMergeBoxBody();
      //expect(instance).to.be.a(Amazonapi.ApiV1BoxesMergeBoxBody);
    });
    ...
    it('should have the property shippingLabel (base name: "shippingLabel")', function() {
      ...
      //var instance = new Amazonapi.ApiV1BoxesMergeBoxBody();
