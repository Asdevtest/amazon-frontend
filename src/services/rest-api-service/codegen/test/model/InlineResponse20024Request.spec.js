...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024Request();
  });
  ...
  describe('InlineResponse20024Request', function() {
    it('should create an instance of InlineResponse20024Request', function() {
      // uncomment below and update the code to test InlineResponse20024Request
      //var instane = new TestSwagger.InlineResponse20024Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20024Request();
