...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject63();
  });
  ...
  describe('InlineObject63', function() {
    it('should create an instance of InlineObject63', function() {
      ...
      //var instane = new TestSwagger.InlineObject63();
      //expect(instance).to.be.a(TestSwagger.InlineObject63);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new TestSwagger.InlineObject63();
