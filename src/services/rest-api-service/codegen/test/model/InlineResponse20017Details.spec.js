...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20017Details();
  });
  ...
  describe('InlineResponse20017Details', function() {
    it('should create an instance of InlineResponse20017Details', function() {
      // uncomment below and update the code to test InlineResponse20017Details
      //var instane = new TestSwagger.InlineResponse20017Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20017Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20017Details();
