...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject16();
  });
  ...
  describe('InlineObject16', function() {
    it('should create an instance of InlineObject16', function() {
      ...
      //var instane = new TestSwagger.InlineObject16();
      //expect(instance).to.be.a(TestSwagger.InlineObject16);
    });
    ...
    it('should have the property destinationId (base name: "destinationId")', function() {
      ...
      //var instance = new TestSwagger.InlineObject16();
