...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject22();
  });
  ...
  describe('InlineObject22', function() {
    it('should create an instance of InlineObject22', function() {
      ...
      //var instane = new TestSwagger.InlineObject22();
      //expect(instance).to.be.a(TestSwagger.InlineObject22);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new TestSwagger.InlineObject22();
