...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.PermissionGetDtoSchema();
  });
  ...
  describe('PermissionGetDtoSchema', function() {
    it('should create an instance of PermissionGetDtoSchema', function() {
      // uncomment below and update the code to test PermissionGetDtoSchema
      //var instane = new TestSwagger.PermissionGetDtoSchema();
      //expect(instance).to.be.a(TestSwagger.PermissionGetDtoSchema);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.PermissionGetDtoSchema();
