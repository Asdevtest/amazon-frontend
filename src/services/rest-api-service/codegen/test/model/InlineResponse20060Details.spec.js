...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20060Details();
  });
  ...
  describe('InlineResponse20060Details', function() {
    it('should create an instance of InlineResponse20060Details', function() {
      // uncomment below and update the code to test InlineResponse20060Details
      //var instane = new TestSwagger.InlineResponse20060Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20060Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20060Details();
