...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20026Request();
  });
  ...
  describe('InlineResponse20026Request', function() {
    it('should create an instance of InlineResponse20026Request', function() {
      // uncomment below and update the code to test InlineResponse20026Request
      //var instane = new TestSwagger.InlineResponse20026Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20026Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20026Request();
