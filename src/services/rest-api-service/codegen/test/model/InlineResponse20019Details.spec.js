...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20019Details();
  });
  ...
  describe('InlineResponse20019Details', function() {
    it('should create an instance of InlineResponse20019Details', function() {
      // uncomment below and update the code to test InlineResponse20019Details
      //var instane = new TestSwagger.InlineResponse20019Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20019Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20019Details();
