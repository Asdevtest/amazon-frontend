...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20041();
  });
  ...
  describe('InlineResponse20041', function() {
    it('should create an instance of InlineResponse20041', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20041();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20041);
    });
    ...
    it('should have the property failed (base name: "failed")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20041();
