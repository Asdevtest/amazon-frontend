...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20062Details();
  });
  ...
  describe('InlineResponse20062Details', function() {
    it('should create an instance of InlineResponse20062Details', function() {
      // uncomment below and update the code to test InlineResponse20062Details
      //var instane = new TestSwagger.InlineResponse20062Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20062Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20062Details();
