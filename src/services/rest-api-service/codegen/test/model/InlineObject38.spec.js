...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject38();
  });
  ...
  describe('InlineObject38', function() {
    it('should create an instance of InlineObject38', function() {
      ...
      //var instane = new Amazonapi.InlineObject38();
      //expect(instance).to.be.a(Amazonapi.InlineObject38);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.InlineObject38();
