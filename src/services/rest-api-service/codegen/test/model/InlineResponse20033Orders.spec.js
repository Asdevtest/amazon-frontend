...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20033Orders();
  });
  ...
  describe('InlineResponse20033Orders', function() {
    it('should create an instance of InlineResponse20033Orders', function() {
      // uncomment below and update the code to test InlineResponse20033Orders
      //var instane = new TestSwagger.InlineResponse20033Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20033Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20033Orders();
