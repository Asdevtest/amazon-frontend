...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20025Products();
  });
  ...
  describe('InlineResponse20025Products', function() {
    it('should create an instance of InlineResponse20025Products', function() {
      // uncomment below and update the code to test InlineResponse20025Products
      //var instane = new TestSwagger.InlineResponse20025Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20025Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20025Products();
