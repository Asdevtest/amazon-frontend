...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.NotFoundError();
  });
  ...
  describe('NotFoundError', function() {
    it('should create an instance of NotFoundError', function() {
      ...
      //var instane = new TestSwagger.NotFoundError();
      //expect(instance).to.be.a(TestSwagger.NotFoundError);
    });

    it('should have the property statusCode (base name: "statusCode")', function() {
      // uncomment below and update the code to test the property statusCode
      //var instance = new TestSwagger.NotFoundError();
