...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsGetProductsByStatusCurrentSupplier();
  });
  ...
  describe('ApiV1AdminsGetProductsByStatusCurrentSupplier', function() {
    it('should create an instance of ApiV1AdminsGetProductsByStatusCurrentSupplier', function() {
      // uncomment below and update the code to test ApiV1AdminsGetProductsByStatusCurrentSupplier
      //var instane = new Amazonapi.ApiV1AdminsGetProductsByStatusCurrentSupplier();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsGetProductsByStatusCurrentSupplier);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.ApiV1AdminsGetProductsByStatusCurrentSupplier();
