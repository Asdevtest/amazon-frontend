...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject25();
  });
  ...
  describe('InlineObject25', function() {
    it('should create an instance of InlineObject25', function() {
      ...
      //var instane = new Amazonapi.InlineObject25();
      //expect(instance).to.be.a(Amazonapi.InlineObject25);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.InlineObject25();
