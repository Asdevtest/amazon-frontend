...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20022Products();
  });
  ...
  describe('InlineResponse20022Products', function() {
    it('should create an instance of InlineResponse20022Products', function() {
      // uncomment below and update the code to test InlineResponse20022Products
      //var instane = new TestSwagger.InlineResponse20022Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20022Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20022Products();
