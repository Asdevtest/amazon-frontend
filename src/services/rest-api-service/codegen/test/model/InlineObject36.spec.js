...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject36();
  });
  ...
  describe('InlineObject36', function() {
    it('should create an instance of InlineObject36', function() {
      ...
      //var instane = new TestSwagger.InlineObject36();
      //expect(instance).to.be.a(TestSwagger.InlineObject36);
    });

    it('should have the property asin (base name: "asin")', function() {
      // uncomment below and update the code to test the property asin
      //var instance = new TestSwagger.InlineObject36();
