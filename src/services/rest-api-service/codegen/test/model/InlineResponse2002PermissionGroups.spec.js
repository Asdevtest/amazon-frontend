...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2002PermissionGroups();
  });
  ...
  describe('InlineResponse2002PermissionGroups', function() {
    it('should create an instance of InlineResponse2002PermissionGroups', function() {
      // uncomment below and update the code to test InlineResponse2002PermissionGroups
      //var instane = new TestSwagger.InlineResponse2002PermissionGroups();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2002PermissionGroups);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse2002PermissionGroups();
