...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject5();
  });
  ...
  describe('InlineObject5', function() {
    it('should create an instance of InlineObject5', function() {
      ...
      //var instane = new TestSwagger.InlineObject5();
      //expect(instance).to.be.a(TestSwagger.InlineObject5);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineObject5();
