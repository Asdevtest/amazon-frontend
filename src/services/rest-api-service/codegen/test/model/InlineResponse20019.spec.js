...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20019();
  });
  ...
  describe('InlineResponse20019', function() {
    it('should create an instance of InlineResponse20019', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20019();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20019);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20019();
