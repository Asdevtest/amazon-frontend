...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024();
  });
  ...
  describe('InlineResponse20024', function() {
    it('should create an instance of InlineResponse20024', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20024();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20024();
