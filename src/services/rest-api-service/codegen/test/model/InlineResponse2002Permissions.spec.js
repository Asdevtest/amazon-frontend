...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2002Permissions();
  });
  ...
  describe('InlineResponse2002Permissions', function() {
    it('should create an instance of InlineResponse2002Permissions', function() {
      // uncomment below and update the code to test InlineResponse2002Permissions
      //var instane = new TestSwagger.InlineResponse2002Permissions();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2002Permissions);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse2002Permissions();
