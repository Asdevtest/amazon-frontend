...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024Rows();
  });
  ...
  describe('InlineResponse20024Rows', function() {
    it('should create an instance of InlineResponse20024Rows', function() {
      // uncomment below and update the code to test InlineResponse20024Rows
      //var instane = new TestSwagger.InlineResponse20024Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20024Rows();
