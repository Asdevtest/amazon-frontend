...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new TestSwagger.InlineResponse2002();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2002);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse2002();
    ...
    it('should have the property isUserPreprocessingCenterUSA (base name: "isUserPreprocessingCenterUSA")', function() {
      // uncomment below and update the code to test the property isUserPreprocessingCenterUSA
      //var instance = new TestSwagger.InlineResponse2002();
      //expect(instance).to.be();
    });
    ...
    it('should have the property masterUserInfo (base name: "masterUserInfo")', function() {
      // uncomment below and update the code to test the property masterUserInfo
      //var instance = new TestSwagger.InlineResponse2002();
      //expect(instance).to.be();
    });
