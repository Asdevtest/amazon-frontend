...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject20();
  });
  ...
  describe('InlineObject20', function() {
    it('should create an instance of InlineObject20', function() {
      ...
      //var instane = new TestSwagger.InlineObject20();
      //expect(instance).to.be.a(TestSwagger.InlineObject20);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new TestSwagger.InlineObject20();
