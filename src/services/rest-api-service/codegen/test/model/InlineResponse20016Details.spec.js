...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20016Details();
  });
  ...
  describe('InlineResponse20016Details', function() {
    it('should create an instance of InlineResponse20016Details', function() {
      // uncomment below and update the code to test InlineResponse20016Details
      //var instane = new TestSwagger.InlineResponse20016Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20016Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20016Details();
