...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024Products();
  });
  ...
  describe('InlineResponse20024Products', function() {
    it('should create an instance of InlineResponse20024Products', function() {
      // uncomment below and update the code to test InlineResponse20024Products
      //var instane = new TestSwagger.InlineResponse20024Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20024Products();
