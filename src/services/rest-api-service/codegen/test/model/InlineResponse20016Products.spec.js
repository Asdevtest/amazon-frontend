...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20016Products();
  });
  ...
  describe('InlineResponse20016Products', function() {
    it('should create an instance of InlineResponse20016Products', function() {
      // uncomment below and update the code to test InlineResponse20016Products
      //var instane = new TestSwagger.InlineResponse20016Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20016Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20016Products();
