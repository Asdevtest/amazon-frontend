...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse2003Createdby();
  });
  ...
  describe('InlineResponse2003Createdby', function() {
    it('should create an instance of InlineResponse2003Createdby', function() {
      // uncomment below and update the code to test InlineResponse2003Createdby
      //var instane = new Amazonapi.InlineResponse2003Createdby();
      //expect(instance).to.be.a(Amazonapi.InlineResponse2003Createdby);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.InlineResponse2003Createdby();
