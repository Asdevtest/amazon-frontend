...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20013Details();
  });
  ...
  describe('InlineResponse20013Details', function() {
    it('should create an instance of InlineResponse20013Details', function() {
      // uncomment below and update the code to test InlineResponse20013Details
      //var instane = new TestSwagger.InlineResponse20013Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20013Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20013Details();
