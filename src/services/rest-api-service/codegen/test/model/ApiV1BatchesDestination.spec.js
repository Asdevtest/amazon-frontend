...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BatchesDestination();
  });
  ...
  describe('ApiV1BatchesDestination', function() {
    it('should create an instance of ApiV1BatchesDestination', function() {
      // uncomment below and update the code to test ApiV1BatchesDestination
      //var instane = new TestSwagger.ApiV1BatchesDestination();
      //expect(instance).to.be.a(TestSwagger.ApiV1BatchesDestination);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.ApiV1BatchesDestination();
