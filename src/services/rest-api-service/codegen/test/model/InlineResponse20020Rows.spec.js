...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20020Rows();
  });
  ...
  describe('InlineResponse20020Rows', function() {
    it('should create an instance of InlineResponse20020Rows', function() {
      // uncomment below and update the code to test InlineResponse20020Rows
      //var instane = new TestSwagger.InlineResponse20020Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20020Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20020Rows();
