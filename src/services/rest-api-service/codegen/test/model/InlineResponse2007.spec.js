...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse2007();
  });
  ...
  describe('InlineResponse2007', function() {
    it('should create an instance of InlineResponse2007', function() {
      ...
      //var instane = new Amazonapi.InlineResponse2007();
      //expect(instance).to.be.a(Amazonapi.InlineResponse2007);
    });
    ...
    it('should have the property taskId (base name: "taskId")', function() {
      ...
      //var instance = new Amazonapi.InlineResponse2007();
