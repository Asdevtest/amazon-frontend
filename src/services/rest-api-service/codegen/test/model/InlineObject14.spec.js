...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject14();
  });
  ...
  describe('InlineObject14', function() {
    it('should create an instance of InlineObject14', function() {
      ...
      //var instane = new TestSwagger.InlineObject14();
      //expect(instance).to.be.a(TestSwagger.InlineObject14);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new TestSwagger.InlineObject14();
