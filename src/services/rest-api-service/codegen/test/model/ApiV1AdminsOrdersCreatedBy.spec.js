...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsOrdersCreatedBy();
  });
  ...
  describe('ApiV1AdminsOrdersCreatedBy', function() {
    it('should create an instance of ApiV1AdminsOrdersCreatedBy', function() {
      // uncomment below and update the code to test ApiV1AdminsOrdersCreatedBy
      //var instane = new Amazonapi.ApiV1AdminsOrdersCreatedBy();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsOrdersCreatedBy);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.ApiV1AdminsOrdersCreatedBy();
