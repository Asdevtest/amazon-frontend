...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BoxesLogicsTariff();
  });
  ...
  describe('ApiV1BoxesLogicsTariff', function() {
    it('should create an instance of ApiV1BoxesLogicsTariff', function() {
      // uncomment below and update the code to test ApiV1BoxesLogicsTariff
      //var instane = new TestSwagger.ApiV1BoxesLogicsTariff();
      //expect(instance).to.be.a(TestSwagger.ApiV1BoxesLogicsTariff);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.ApiV1BoxesLogicsTariff();
    ...
    it('should have the property atd (base name: "atd")', function() {
      // uncomment below and update the code to test the property atd
      //var instance = new TestSwagger.ApiV1BoxesLogicsTariff();
      //expect(instance).to.be();
    });
