...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20028Details();
  });
  ...
  describe('InlineResponse20028Details', function() {
    it('should create an instance of InlineResponse20028Details', function() {
      // uncomment below and update the code to test InlineResponse20028Details
      //var instane = new TestSwagger.InlineResponse20028Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20028Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20028Details();
