...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20054Details();
  });
  ...
  describe('InlineResponse20054Details', function() {
    it('should create an instance of InlineResponse20054Details', function() {
      // uncomment below and update the code to test InlineResponse20054Details
      //var instane = new TestSwagger.InlineResponse20054Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20054Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20054Details();
