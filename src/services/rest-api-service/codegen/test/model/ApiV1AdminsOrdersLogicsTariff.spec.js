...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1AdminsOrdersLogicsTariff();
  });
  ...
  describe('ApiV1AdminsOrdersLogicsTariff', function() {
    it('should create an instance of ApiV1AdminsOrdersLogicsTariff', function() {
      // uncomment below and update the code to test ApiV1AdminsOrdersLogicsTariff
      //var instane = new TestSwagger.ApiV1AdminsOrdersLogicsTariff();
      //expect(instance).to.be.a(TestSwagger.ApiV1AdminsOrdersLogicsTariff);
    });
