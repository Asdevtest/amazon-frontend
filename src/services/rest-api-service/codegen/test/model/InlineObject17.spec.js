...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject17();
  });
  ...
  describe('InlineObject17', function() {
    it('should create an instance of InlineObject17', function() {
      ...
      //var instane = new Amazonapi.InlineObject17();
      //expect(instance).to.be.a(Amazonapi.InlineObject17);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Amazonapi.InlineObject17();
