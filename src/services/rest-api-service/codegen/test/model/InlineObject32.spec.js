...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject32();
  });
  ...
  describe('InlineObject32', function() {
    it('should create an instance of InlineObject32', function() {
      ...
      //var instane = new Amazonapi.InlineObject32();
      //expect(instance).to.be.a(Amazonapi.InlineObject32);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.InlineObject32();
