...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20023Details();
  });
  ...
  describe('InlineResponse20023Details', function() {
    it('should create an instance of InlineResponse20023Details', function() {
      // uncomment below and update the code to test InlineResponse20023Details
      //var instane = new TestSwagger.InlineResponse20023Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20023Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20023Details();
