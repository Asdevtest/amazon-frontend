...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20061Details();
  });
  ...
  describe('InlineResponse20061Details', function() {
    it('should create an instance of InlineResponse20061Details', function() {
      // uncomment below and update the code to test InlineResponse20061Details
      //var instane = new TestSwagger.InlineResponse20061Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20061Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20061Details();
