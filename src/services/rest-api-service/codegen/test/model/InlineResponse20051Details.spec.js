...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20051Details();
  });
  ...
  describe('InlineResponse20051Details', function() {
    it('should create an instance of InlineResponse20051Details', function() {
      // uncomment below and update the code to test InlineResponse20051Details
      //var instane = new TestSwagger.InlineResponse20051Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20051Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20051Details();
