...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2011();
  });
  ...
  describe('InlineResponse2011', function() {
    it('should create an instance of InlineResponse2011', function() {
      ...
      //var instane = new TestSwagger.InlineResponse2011();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2011);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new TestSwagger.InlineResponse2011();
