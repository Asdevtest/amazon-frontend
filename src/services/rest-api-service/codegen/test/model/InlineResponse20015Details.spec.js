...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20015Details();
  });
  ...
  describe('InlineResponse20015Details', function() {
    it('should create an instance of InlineResponse20015Details', function() {
      // uncomment below and update the code to test InlineResponse20015Details
      //var instane = new TestSwagger.InlineResponse20015Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20015Details);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.InlineResponse20015Details();
