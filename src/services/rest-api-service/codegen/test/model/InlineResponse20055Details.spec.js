...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20055Details();
  });
  ...
  describe('InlineResponse20055Details', function() {
    it('should create an instance of InlineResponse20055Details', function() {
      // uncomment below and update the code to test InlineResponse20055Details
      //var instane = new TestSwagger.InlineResponse20055Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20055Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20055Details();
