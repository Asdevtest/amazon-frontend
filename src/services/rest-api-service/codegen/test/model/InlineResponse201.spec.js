...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse201();
  });
  ...
  describe('InlineResponse201', function() {
    it('should create an instance of InlineResponse201', function() {
      ...
      //var instane = new Amazonapi.InlineResponse201();
      //expect(instance).to.be.a(Amazonapi.InlineResponse201);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new Amazonapi.InlineResponse201();
