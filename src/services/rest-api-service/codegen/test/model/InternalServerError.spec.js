...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InternalServerError();
  });
  ...
  describe('InternalServerError', function() {
    it('should create an instance of InternalServerError', function() {
      ...
      //var instane = new TestSwagger.InternalServerError();
      //expect(instance).to.be.a(TestSwagger.InternalServerError);
    });

    it('should have the property statusCode (base name: "statusCode")', function() {
      // uncomment below and update the code to test the property statusCode
      //var instance = new TestSwagger.InternalServerError();
