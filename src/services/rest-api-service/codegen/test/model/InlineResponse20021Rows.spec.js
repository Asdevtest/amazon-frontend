...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Rows();
  });
  ...
  describe('InlineResponse20021Rows', function() {
    it('should create an instance of InlineResponse20021Rows', function() {
      // uncomment below and update the code to test InlineResponse20021Rows
      //var instane = new TestSwagger.InlineResponse20021Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20021Rows();
