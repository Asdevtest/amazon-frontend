...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsCustomDetails();
  });
  ...
  describe('ApiV1RequestsCustomDetails', function() {
    it('should create an instance of ApiV1RequestsCustomDetails', function() {
      // uncomment below and update the code to test ApiV1RequestsCustomDetails
      //var instane = new TestSwagger.ApiV1RequestsCustomDetails();
