...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024Orders();
  });
  ...
  describe('InlineResponse20024Orders', function() {
    it('should create an instance of InlineResponse20024Orders', function() {
      // uncomment below and update the code to test InlineResponse20024Orders
      //var instane = new TestSwagger.InlineResponse20024Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20024Orders();
