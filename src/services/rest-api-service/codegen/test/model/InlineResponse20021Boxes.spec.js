...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Boxes();
  });
  ...
  describe('InlineResponse20021Boxes', function() {
    it('should create an instance of InlineResponse20021Boxes', function() {
      // uncomment below and update the code to test InlineResponse20021Boxes
      //var instane = new TestSwagger.InlineResponse20021Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20021Boxes();
