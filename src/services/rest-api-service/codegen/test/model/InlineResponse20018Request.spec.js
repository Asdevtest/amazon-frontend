...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20018Request();
  });
  ...
  describe('InlineResponse20018Request', function() {
    it('should create an instance of InlineResponse20018Request', function() {
      // uncomment below and update the code to test InlineResponse20018Request
      //var instane = new TestSwagger.InlineResponse20018Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20018Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20018Request();
