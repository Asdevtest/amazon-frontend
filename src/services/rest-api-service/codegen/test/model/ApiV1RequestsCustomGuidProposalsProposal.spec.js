...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsCustomGuidProposalsProposal();
  });
  ...
  describe('ApiV1RequestsCustomGuidProposalsProposal', function() {
    it('should create an instance of ApiV1RequestsCustomGuidProposalsProposal', function() {
      // uncomment below and update the code to test ApiV1RequestsCustomGuidProposalsProposal
      //var instane = new TestSwagger.ApiV1RequestsCustomGuidProposalsProposal();
      //expect(instance).to.be.a(TestSwagger.ApiV1RequestsCustomGuidProposalsProposal);
    });
