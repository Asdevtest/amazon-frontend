...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1AdminsGetProductsByStatusBoxAmounts();
  });
  ...
  describe('ApiV1AdminsGetProductsByStatusBoxAmounts', function() {
    it('should create an instance of ApiV1AdminsGetProductsByStatusBoxAmounts', function() {
      // uncomment below and update the code to test ApiV1AdminsGetProductsByStatusBoxAmounts
      //var instane = new TestSwagger.ApiV1AdminsGetProductsByStatusBoxAmounts();
      //expect(instance).to.be.a(TestSwagger.ApiV1AdminsGetProductsByStatusBoxAmounts);
    });
