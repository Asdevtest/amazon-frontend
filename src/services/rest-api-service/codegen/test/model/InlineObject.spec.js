...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new TestSwagger.InlineObject();
      //expect(instance).to.be.a(TestSwagger.InlineObject);
    });

    it('should have the property boxId (base name: "boxId")', function() {
      // uncomment below and update the code to test the property boxId
      //var instance = new TestSwagger.InlineObject();
