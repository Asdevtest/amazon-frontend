...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20025Orders();
  });
  ...
  describe('InlineResponse20025Orders', function() {
    it('should create an instance of InlineResponse20025Orders', function() {
      // uncomment below and update the code to test InlineResponse20025Orders
      //var instane = new TestSwagger.InlineResponse20025Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20025Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20025Orders();
