...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20058Details();
  });
  ...
  describe('InlineResponse20058Details', function() {
    it('should create an instance of InlineResponse20058Details', function() {
      // uncomment below and update the code to test InlineResponse20058Details
      //var instane = new TestSwagger.InlineResponse20058Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20058Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20058Details();
