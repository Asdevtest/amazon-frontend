...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20064Details();
  });
  ...
  describe('InlineResponse20064Details', function() {
    it('should create an instance of InlineResponse20064Details', function() {
      // uncomment below and update the code to test InlineResponse20064Details
      //var instane = new TestSwagger.InlineResponse20064Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20064Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20064Details();
