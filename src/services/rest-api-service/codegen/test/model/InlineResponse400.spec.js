...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse400();
  });
  ...
  describe('InlineResponse400', function() {
    it('should create an instance of InlineResponse400', function() {
      ...
      //var instane = new Amazonapi.InlineResponse400();
      //expect(instance).to.be.a(Amazonapi.InlineResponse400);
    });

    it('should have the property statusCode (base name: "statusCode")', function() {
      // uncomment below and update the code to test the property statusCode
      //var instance = new Amazonapi.InlineResponse400();
