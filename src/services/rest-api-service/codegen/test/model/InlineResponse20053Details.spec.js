...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20053Details();
  });
  ...
  describe('InlineResponse20053Details', function() {
    it('should create an instance of InlineResponse20053Details', function() {
      // uncomment below and update the code to test InlineResponse20053Details
      //var instane = new TestSwagger.InlineResponse20053Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20053Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20053Details();
