...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject10();
  });
  ...
  describe('InlineObject10', function() {
    it('should create an instance of InlineObject10', function() {
      ...
      //var instane = new Amazonapi.InlineObject10();
      //expect(instance).to.be.a(Amazonapi.InlineObject10);
    });
    ...
    it('should have the property lengthCm (base name: "lengthCm")', function() {
      ...
      //var instance = new Amazonapi.InlineObject10();
