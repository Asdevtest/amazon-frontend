...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20043Details();
  });
  ...
  describe('InlineResponse20043Details', function() {
    it('should create an instance of InlineResponse20043Details', function() {
      // uncomment below and update the code to test InlineResponse20043Details
      //var instane = new TestSwagger.InlineResponse20043Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20043Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20043Details();
