...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20022Rows();
  });
  ...
  describe('InlineResponse20022Rows', function() {
    it('should create an instance of InlineResponse20022Rows', function() {
      // uncomment below and update the code to test InlineResponse20022Rows
      //var instane = new TestSwagger.InlineResponse20022Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20022Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20022Rows();
