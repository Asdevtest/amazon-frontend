...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.UserFullSchema();
  });
  ...
  describe('UserFullSchema', function() {
    it('should create an instance of UserFullSchema', function() {
      // uncomment below and update the code to test UserFullSchema
      //var instane = new TestSwagger.UserFullSchema();
      //expect(instance).to.be.a(TestSwagger.UserFullSchema);
    });
