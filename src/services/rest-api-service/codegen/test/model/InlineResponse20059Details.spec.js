...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20059Details();
  });
  ...
  describe('InlineResponse20059Details', function() {
    it('should create an instance of InlineResponse20059Details', function() {
      // uncomment below and update the code to test InlineResponse20059Details
      //var instane = new TestSwagger.InlineResponse20059Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20059Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20059Details();
