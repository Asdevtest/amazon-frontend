...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject31();
  });
  ...
  describe('InlineObject31', function() {
    it('should create an instance of InlineObject31', function() {
      ...
      //var instane = new Amazonapi.InlineObject31();
      //expect(instance).to.be.a(Amazonapi.InlineObject31);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.InlineObject31();
