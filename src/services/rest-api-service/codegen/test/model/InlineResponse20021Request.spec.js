...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Request();
  });
  ...
  describe('InlineResponse20021Request', function() {
    it('should create an instance of InlineResponse20021Request', function() {
      // uncomment below and update the code to test InlineResponse20021Request
      //var instane = new TestSwagger.InlineResponse20021Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20021Request();
