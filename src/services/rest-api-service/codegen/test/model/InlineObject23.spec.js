...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject23();
  });
  ...
  describe('InlineObject23', function() {
    it('should create an instance of InlineObject23', function() {
      ...
      //var instane = new TestSwagger.InlineObject23();
      //expect(instance).to.be.a(TestSwagger.InlineObject23);
    });

    it('should have the property guid (base name: "guid")', function() {
      // uncomment below and update the code to test the property guid
      //var instance = new TestSwagger.InlineObject23();
