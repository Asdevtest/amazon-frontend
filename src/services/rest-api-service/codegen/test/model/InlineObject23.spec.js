...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject23();
  });
  ...
  describe('InlineObject23', function() {
    it('should create an instance of InlineObject23', function() {
      ...
      //var instane = new Amazonapi.InlineObject23();
      //expect(instance).to.be.a(Amazonapi.InlineObject23);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Amazonapi.InlineObject23();
