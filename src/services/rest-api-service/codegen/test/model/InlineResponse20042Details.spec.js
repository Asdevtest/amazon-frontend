...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20042Details();
  });
  ...
  describe('InlineResponse20042Details', function() {
    it('should create an instance of InlineResponse20042Details', function() {
      // uncomment below and update the code to test InlineResponse20042Details
      //var instane = new TestSwagger.InlineResponse20042Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20042Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20042Details();
