...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20023Orders();
  });
  ...
  describe('InlineResponse20023Orders', function() {
    it('should create an instance of InlineResponse20023Orders', function() {
      // uncomment below and update the code to test InlineResponse20023Orders
      //var instane = new TestSwagger.InlineResponse20023Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20023Orders);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20023Orders();
