...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20034Details();
  });
  ...
  describe('InlineResponse20034Details', function() {
    it('should create an instance of InlineResponse20034Details', function() {
      // uncomment below and update the code to test InlineResponse20034Details
      //var instane = new TestSwagger.InlineResponse20034Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20034Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20034Details();
