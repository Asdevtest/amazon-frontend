...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20030Orders();
  });
  ...
  describe('InlineResponse20030Orders', function() {
    it('should create an instance of InlineResponse20030Orders', function() {
      // uncomment below and update the code to test InlineResponse20030Orders
      //var instane = new TestSwagger.InlineResponse20030Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20030Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20030Orders();
