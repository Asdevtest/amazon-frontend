...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject42();
  });
  ...
  describe('InlineObject42', function() {
    it('should create an instance of InlineObject42', function() {
      ...
      //var instane = new Amazonapi.InlineObject42();
      //expect(instance).to.be.a(Amazonapi.InlineObject42);
    });

    it('should have the property role (base name: "role")', function() {
      // uncomment below and update the code to test the property role
      //var instance = new Amazonapi.InlineObject42();
