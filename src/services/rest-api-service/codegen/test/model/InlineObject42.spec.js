...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject42();
  });
  ...
  describe('InlineObject42', function() {
    it('should create an instance of InlineObject42', function() {
      ...
      //var instane = new TestSwagger.InlineObject42();
      //expect(instance).to.be.a(TestSwagger.InlineObject42);
    });
    ...
    it('should have the property clientComment (base name: "clientComment")', function() {
      ...
      //var instance = new TestSwagger.InlineObject42();
