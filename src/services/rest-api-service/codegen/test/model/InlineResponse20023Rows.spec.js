...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20023Rows();
  });
  ...
  describe('InlineResponse20023Rows', function() {
    it('should create an instance of InlineResponse20023Rows', function() {
      // uncomment below and update the code to test InlineResponse20023Rows
      //var instane = new TestSwagger.InlineResponse20023Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20023Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20023Rows();
