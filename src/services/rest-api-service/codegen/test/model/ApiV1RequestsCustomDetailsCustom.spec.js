...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsCustomDetailsCustom();
  });
  ...
  describe('ApiV1RequestsCustomDetailsCustom', function() {
    it('should create an instance of ApiV1RequestsCustomDetailsCustom', function() {
      // uncomment below and update the code to test ApiV1RequestsCustomDetailsCustom
      //var instane = new TestSwagger.ApiV1RequestsCustomDetailsCustom();
      //expect(instance).to.be.a(TestSwagger.ApiV1RequestsCustomDetailsCustom);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.ApiV1RequestsCustomDetailsCustom();
