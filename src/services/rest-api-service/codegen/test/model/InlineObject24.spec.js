...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject24();
  });
  ...
  describe('InlineObject24', function() {
    it('should create an instance of InlineObject24', function() {
      ...
      //var instane = new Amazonapi.InlineObject24();
      //expect(instance).to.be.a(Amazonapi.InlineObject24);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new Amazonapi.InlineObject24();
