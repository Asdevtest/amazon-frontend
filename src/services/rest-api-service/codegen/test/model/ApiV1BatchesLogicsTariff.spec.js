...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BatchesLogicsTariff();
  });
  ...
  describe('ApiV1BatchesLogicsTariff', function() {
    it('should create an instance of ApiV1BatchesLogicsTariff', function() {
      // uncomment below and update the code to test ApiV1BatchesLogicsTariff
      //var instane = new TestSwagger.ApiV1BatchesLogicsTariff();
      //expect(instance).to.be.a(TestSwagger.ApiV1BatchesLogicsTariff);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TestSwagger.ApiV1BatchesLogicsTariff();
