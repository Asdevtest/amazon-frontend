...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20032Orders();
  });
  ...
  describe('InlineResponse20032Orders', function() {
    it('should create an instance of InlineResponse20032Orders', function() {
      // uncomment below and update the code to test InlineResponse20032Orders
      //var instane = new TestSwagger.InlineResponse20032Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20032Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20032Orders();
