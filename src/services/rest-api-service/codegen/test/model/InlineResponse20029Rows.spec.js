...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20029Rows();
  });
  ...
  describe('InlineResponse20029Rows', function() {
    it('should create an instance of InlineResponse20029Rows', function() {
      // uncomment below and update the code to test InlineResponse20029Rows
      //var instane = new TestSwagger.InlineResponse20029Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20029Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20029Rows();
