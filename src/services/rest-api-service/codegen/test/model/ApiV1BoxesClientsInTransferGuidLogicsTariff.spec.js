...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BoxesClientsInTransferGuidLogicsTariff();
  });
  ...
  describe('ApiV1BoxesClientsInTransferGuidLogicsTariff', function() {
    it('should create an instance of ApiV1BoxesClientsInTransferGuidLogicsTariff', function() {
      // uncomment below and update the code to test ApiV1BoxesClientsInTransferGuidLogicsTariff
      //var instane = new TestSwagger.ApiV1BoxesClientsInTransferGuidLogicsTariff();
      //expect(instance).to.be.a(TestSwagger.ApiV1BoxesClientsInTransferGuidLogicsTariff);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.ApiV1BoxesClientsInTransferGuidLogicsTariff();
