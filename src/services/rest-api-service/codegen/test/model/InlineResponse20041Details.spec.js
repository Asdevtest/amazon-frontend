...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20041Details();
  });
  ...
  describe('InlineResponse20041Details', function() {
    it('should create an instance of InlineResponse20041Details', function() {
      // uncomment below and update the code to test InlineResponse20041Details
      //var instane = new TestSwagger.InlineResponse20041Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20041Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20041Details();
