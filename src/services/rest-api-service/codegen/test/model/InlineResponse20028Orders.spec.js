...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20028Orders();
  });
  ...
  describe('InlineResponse20028Orders', function() {
    it('should create an instance of InlineResponse20028Orders', function() {
      // uncomment below and update the code to test InlineResponse20028Orders
      //var instane = new TestSwagger.InlineResponse20028Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20028Orders);
    });
