...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20021Orders();
  });
  ...
  describe('InlineResponse20021Orders', function() {
    it('should create an instance of InlineResponse20021Orders', function() {
      // uncomment below and update the code to test InlineResponse20021Orders
      //var instane = new TestSwagger.InlineResponse20021Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20021Orders);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20021Orders();
