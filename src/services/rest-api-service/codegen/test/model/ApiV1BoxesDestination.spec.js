...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1BoxesDestination();
  });
  ...
  describe('ApiV1BoxesDestination', function() {
    it('should create an instance of ApiV1BoxesDestination', function() {
      // uncomment below and update the code to test ApiV1BoxesDestination
      //var instane = new TestSwagger.ApiV1BoxesDestination();
      //expect(instance).to.be.a(TestSwagger.ApiV1BoxesDestination);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.ApiV1BoxesDestination();
