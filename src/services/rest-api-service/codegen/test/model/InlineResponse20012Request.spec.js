...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20012Request();
  });
  ...
  describe('InlineResponse20012Request', function() {
    it('should create an instance of InlineResponse20012Request', function() {
      // uncomment below and update the code to test InlineResponse20012Request
      //var instane = new TestSwagger.InlineResponse20012Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20012Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20012Request();
