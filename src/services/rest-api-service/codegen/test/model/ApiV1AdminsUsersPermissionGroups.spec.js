...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.ApiV1AdminsUsersPermissionGroups();
  });
  ...
  describe('ApiV1AdminsUsersPermissionGroups', function() {
    it('should create an instance of ApiV1AdminsUsersPermissionGroups', function() {
      // uncomment below and update the code to test ApiV1AdminsUsersPermissionGroups
      //var instane = new Amazonapi.ApiV1AdminsUsersPermissionGroups();
      //expect(instance).to.be.a(Amazonapi.ApiV1AdminsUsersPermissionGroups);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new Amazonapi.ApiV1AdminsUsersPermissionGroups();
