...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20030Products();
  });
  ...
  describe('InlineResponse20030Products', function() {
    it('should create an instance of InlineResponse20030Products', function() {
      // uncomment below and update the code to test InlineResponse20030Products
      //var instane = new TestSwagger.InlineResponse20030Products();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20030Products);
    });

    it('should have the property all (base name: "all")', function() {
      // uncomment below and update the code to test the property all
      //var instance = new TestSwagger.InlineResponse20030Products();
