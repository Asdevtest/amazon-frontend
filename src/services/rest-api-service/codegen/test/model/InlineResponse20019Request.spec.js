...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20019Request();
  });
  ...
  describe('InlineResponse20019Request', function() {
    it('should create an instance of InlineResponse20019Request', function() {
      // uncomment below and update the code to test InlineResponse20019Request
      //var instane = new TestSwagger.InlineResponse20019Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20019Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20019Request();
