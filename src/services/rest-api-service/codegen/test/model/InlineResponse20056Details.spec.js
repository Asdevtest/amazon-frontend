...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20056Details();
  });
  ...
  describe('InlineResponse20056Details', function() {
    it('should create an instance of InlineResponse20056Details', function() {
      // uncomment below and update the code to test InlineResponse20056Details
      //var instane = new TestSwagger.InlineResponse20056Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20056Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20056Details();
