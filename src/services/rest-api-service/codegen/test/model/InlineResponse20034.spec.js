...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20034();
  });
  ...
  describe('InlineResponse20034', function() {
    it('should create an instance of InlineResponse20034', function() {
      ...
      //var instane = new TestSwagger.InlineResponse20034();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20034);
    });

    it('should have the property products (base name: "products")', function() {
      // uncomment below and update the code to test the property products
      //var instance = new TestSwagger.InlineResponse20034();
