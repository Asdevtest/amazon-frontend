...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20032Details();
  });
  ...
  describe('InlineResponse20032Details', function() {
    it('should create an instance of InlineResponse20032Details', function() {
      // uncomment below and update the code to test InlineResponse20032Details
      //var instane = new TestSwagger.InlineResponse20032Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20032Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20032Details();
