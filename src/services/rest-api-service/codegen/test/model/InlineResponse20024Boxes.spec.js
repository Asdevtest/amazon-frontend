...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20024Boxes();
  });
  ...
  describe('InlineResponse20024Boxes', function() {
    it('should create an instance of InlineResponse20024Boxes', function() {
      // uncomment below and update the code to test InlineResponse20024Boxes
      //var instane = new TestSwagger.InlineResponse20024Boxes();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20024Boxes);
    });
    ...
    it('should have the property inStock (base name: "inStock")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20024Boxes();
