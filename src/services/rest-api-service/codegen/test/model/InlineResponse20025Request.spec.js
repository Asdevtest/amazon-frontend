...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20025Request();
  });
  ...
  describe('InlineResponse20025Request', function() {
    it('should create an instance of InlineResponse20025Request', function() {
      // uncomment below and update the code to test InlineResponse20025Request
      //var instane = new TestSwagger.InlineResponse20025Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20025Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20025Request();
