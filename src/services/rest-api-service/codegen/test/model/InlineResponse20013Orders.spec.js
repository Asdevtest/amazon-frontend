...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20013Orders();
  });
  ...
  describe('InlineResponse20013Orders', function() {
    it('should create an instance of InlineResponse20013Orders', function() {
      // uncomment below and update the code to test InlineResponse20013Orders
      //var instane = new TestSwagger.InlineResponse20013Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20013Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20013Orders();
