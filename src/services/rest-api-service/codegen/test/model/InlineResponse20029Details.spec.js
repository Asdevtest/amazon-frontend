...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20029Details();
  });
  ...
  describe('InlineResponse20029Details', function() {
    it('should create an instance of InlineResponse20029Details', function() {
      // uncomment below and update the code to test InlineResponse20029Details
      //var instane = new TestSwagger.InlineResponse20029Details();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20029Details);
    });
    ...
    it('should have the property conditions (base name: "conditions")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20029Details();
