...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1AdminsBatchesBatch();
  });
  ...
  describe('ApiV1AdminsBatchesBatch', function() {
    it('should create an instance of ApiV1AdminsBatchesBatch', function() {
      // uncomment below and update the code to test ApiV1AdminsBatchesBatch
      //var instane = new TestSwagger.ApiV1AdminsBatchesBatch();
      //expect(instance).to.be.a(TestSwagger.ApiV1AdminsBatchesBatch);
    });
    ...
    it('should have the property deliveryMethod (base name: "deliveryMethod")', function() {
      ...
      //var instance = new TestSwagger.ApiV1AdminsBatchesBatch();
