...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20014Rows();
  });
  ...
  describe('InlineResponse20014Rows', function() {
    it('should create an instance of InlineResponse20014Rows', function() {
      // uncomment below and update the code to test InlineResponse20014Rows
      //var instane = new TestSwagger.InlineResponse20014Rows();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20014Rows);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20014Rows();
