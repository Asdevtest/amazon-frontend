...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject18();
  });
  ...
  describe('InlineObject18', function() {
    it('should create an instance of InlineObject18', function() {
      ...
      //var instane = new Amazonapi.InlineObject18();
      //expect(instance).to.be.a(Amazonapi.InlineObject18);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Amazonapi.InlineObject18();
