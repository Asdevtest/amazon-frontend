...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1RequestsCustomGuidRequest();
  });
  ...
  describe('ApiV1RequestsCustomGuidRequest', function() {
    it('should create an instance of ApiV1RequestsCustomGuidRequest', function() {
      // uncomment below and update the code to test ApiV1RequestsCustomGuidRequest
      //var instane = new TestSwagger.ApiV1RequestsCustomGuidRequest();
