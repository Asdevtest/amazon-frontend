...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineObject41();
  });
  ...
  describe('InlineObject41', function() {
    it('should create an instance of InlineObject41', function() {
      ...
      //var instane = new TestSwagger.InlineObject41();
      //expect(instance).to.be.a(TestSwagger.InlineObject41);
    });
    ...
    it('should have the property taskId (base name: "taskId")', function() {
      ...
      //var instance = new TestSwagger.InlineObject41();
