...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineObject41();
  });
  ...
  describe('InlineObject41', function() {
    it('should create an instance of InlineObject41', function() {
      ...
      //var instane = new Amazonapi.InlineObject41();
      //expect(instance).to.be.a(Amazonapi.InlineObject41);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new Amazonapi.InlineObject41();
