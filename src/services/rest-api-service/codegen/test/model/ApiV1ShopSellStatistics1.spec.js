...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.ApiV1ShopSellStatistics1();
  });
  ...
  describe('ApiV1ShopSellStatistics1', function() {
    it('should create an instance of ApiV1ShopSellStatistics1', function() {
      // uncomment below and update the code to test ApiV1ShopSellStatistics1
      //var instane = new TestSwagger.ApiV1ShopSellStatistics1();
      //expect(instance).to.be.a(TestSwagger.ApiV1ShopSellStatistics1);
    });

    it('should have the property month (base name: "month")', function() {
      // uncomment below and update the code to test the property month
      //var instance = new TestSwagger.ApiV1ShopSellStatistics1();
