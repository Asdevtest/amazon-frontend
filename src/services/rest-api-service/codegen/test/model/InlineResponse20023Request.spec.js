...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20023Request();
  });
  ...
  describe('InlineResponse20023Request', function() {
    it('should create an instance of InlineResponse20023Request', function() {
      // uncomment below and update the code to test InlineResponse20023Request
      //var instane = new TestSwagger.InlineResponse20023Request();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20023Request);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.InlineResponse20023Request();
