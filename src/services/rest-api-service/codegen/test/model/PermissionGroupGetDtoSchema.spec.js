...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.PermissionGroupGetDtoSchema();
  });
  ...
  describe('PermissionGroupGetDtoSchema', function() {
    it('should create an instance of PermissionGroupGetDtoSchema', function() {
      // uncomment below and update the code to test PermissionGroupGetDtoSchema
      //var instane = new TestSwagger.PermissionGroupGetDtoSchema();
      //expect(instance).to.be.a(TestSwagger.PermissionGroupGetDtoSchema);
    });

    it('should have the property _id (base name: "_id")', function() {
      // uncomment below and update the code to test the property _id
      //var instance = new TestSwagger.PermissionGroupGetDtoSchema();
