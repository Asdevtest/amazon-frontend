...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse20027Orders();
  });
  ...
  describe('InlineResponse20027Orders', function() {
    it('should create an instance of InlineResponse20027Orders', function() {
      // uncomment below and update the code to test InlineResponse20027Orders
      //var instane = new TestSwagger.InlineResponse20027Orders();
      //expect(instance).to.be.a(TestSwagger.InlineResponse20027Orders);
    });
    ...
    it('should have the property inProcess (base name: "inProcess")', function() {
      ...
      //var instance = new TestSwagger.InlineResponse20027Orders();
