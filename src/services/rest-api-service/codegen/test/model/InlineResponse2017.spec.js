...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Amazonapi.InlineResponse2017();
  });
  ...
  describe('InlineResponse2017', function() {
    it('should create an instance of InlineResponse2017', function() {
      ...
      //var instane = new Amazonapi.InlineResponse2017();
      //expect(instance).to.be.a(Amazonapi.InlineResponse2017);
    });

    it('should have the property token (base name: "token")', function() {
      // uncomment below and update the code to test the property token
      //var instance = new Amazonapi.InlineResponse2017();
