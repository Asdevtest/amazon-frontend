...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestSwagger.InlineResponse2017();
  });
  ...
  describe('InlineResponse2017', function() {
    it('should create an instance of InlineResponse2017', function() {
      ...
      //var instane = new TestSwagger.InlineResponse2017();
      //expect(instance).to.be.a(TestSwagger.InlineResponse2017);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TestSwagger.InlineResponse2017();
