...
> [InlineResponse2007] apiV1BoxesClientsInTransferGuidGet(guid, opts)
...
> [InlineResponse2006] apiV1BoxesClientsLightGet(status, opts)
...
> [InlineResponse2009] apiV1BoxesClientsSentToBatchGet(opts)
...
> InlineResponse20011 apiV1BoxesGroupedGet(opts)
...
> InlineResponse20010 apiV1BoxesGroupedGroupsGet(opts)
...
> [InlineResponse2005] apiV1BoxesGroupedSimilarGet(opts)
...
> InlineResponse2008 apiV1BoxesPagClientsLightGet(status, opts)
...
> [InlineResponse2009] apiV1BoxesStorekeepersSentToBatchGet(opts)
