...
**deliveryLength** | **Number** | Размеры доставки. | [optional] 
**deliveryWidth** | **Number** | Размеры доставки. | [optional] 
**deliveryHeight** | **Number** | Размеры доставки. | [optional] 
**deliveryMass** | **Number** | Масса доставки | [optional] 
