...
> [InlineResponse20058] apiV1RequestsByProductLightGuidGet(guid, opts)
...
> InlineResponse20057 apiV1RequestsGet(kind, opts)
...
> [InlineResponse20056] apiV1RequestsGetExistingRequestsTypeTaskGuidGet(guid, typeTask, opts)
