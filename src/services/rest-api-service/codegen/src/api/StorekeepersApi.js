...
export default class StorekeepersApi {
    ...
    */
     ...
     * @param {Number} opts.tariffType Тип тарифа(10, 20)
     * @param {String} opts.Accept_Encoding 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/ApiV1BatchesOrderLogicsTariff>} and HTTP response
     */
    apiV1StorekeepersTariffLogisticsMyGetWithHttpInfo(opts) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ApiV1BatchesOrderLogicsTariff];
      return this.apiClient.callApi(
     ...
     * @param {Number} opts.tariffType Тип тарифа(10, 20)
     * @param {String} opts.Accept_Encoding 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/ApiV1BatchesOrderLogicsTariff>}
     */
