...
export default class SupervisorApi {
  ...
  apiV1SupervisorsPaymentsCreatedByThisSuperGet(opts) {
    return this.apiV1SupervisorsPaymentsCreatedByThisSuperGetWithHttpInfo(opts).then(function(
      response_and_data
    ){
  ...
  apiV1SupervisorsPaymentsMyBalanceGet(opts) {
    return this.apiV1SupervisorsPaymentsMyBalanceGetWithHttpInfo(opts).then(function(
      response_and_data
    ){
      return response_and_data.data;
    });
  ...
  apiV1SupervisorsProductsGuidPatchWithHttpInfo(guid, InlineObject23, opts) {
    ...
    if (guid === undefined || guid === null) {
      throw new Error(
        "Missing the required parameter 'guid' when calling apiV1SupervisorsProductsGuidPatch"
      );
    }
    // verify the required parameter 'InlineObject23' is set
    if (InlineObject23 === undefined || InlineObject23 === null) {
      throw new Error(
        "Missing the required parameter 'InlineObject23' when calling apiV1SupervisorsProductsGuidPatch"
      );
    }
  ...
  apiV1SupervisorsProductsGuidPatch(guid, InlineObject23, opts) {
    return this.apiV1SupervisorsProductsGuidPatchWithHttpInfo(
      guid,
      InlineObject23,
      opts
  ...
  apiV1SupervisorsProductsPickupGuidPostWithHttpInfo(guid, opts) {
    ...
    if (guid === undefined || guid === null) {
      throw new Error(
        "Missing the required parameter 'guid' when calling apiV1SupervisorsProductsPickupGuidPost"
      );
    }
  ...
  apiV1SupervisorsProductsPickupGuidPost(guid, opts) {
    return this.apiV1SupervisorsProductsPickupGuidPostWithHttpInfo(guid, opts).then(function(
      response_and_data
    ){
      return response_and_data.data;
    });
