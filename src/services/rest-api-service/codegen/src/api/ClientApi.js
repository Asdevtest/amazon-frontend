...
export default class ClientApi {
  ...
  apiV1ClientsOrdersPost(opts) {
    return this.apiV1ClientsOrdersPostWithHttpInfo(opts).then(function(response_and_data){
      return response_and_data.data
    })
  }
  ...
  apiV1ClientsProductsMyGetWithHttpInfo(filters, opts) {
    opts = opts || {}
    let postBody = null
    // verify the required parameter 'filters' is set
    if (filters === undefined || filters === null) {
      throw new Error("Missing the required parameter 'filters' when calling apiV1ClientsProductsMyGet")
    }
  ...
  apiV1ClientsTasksPost(opts) {
    return this.apiV1ClientsTasksPostWithHttpInfo(opts).then(function(response_and_data){
      return response_and_data.data
    })
  }
}
