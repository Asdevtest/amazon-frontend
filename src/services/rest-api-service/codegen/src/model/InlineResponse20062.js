 ...
 */
InlineResponse20062.prototype['bidderId'] = undefined;

/**
 * GUID модератора магазина
 * @member {String} moderatorId
 */
InlineResponse20062.prototype['moderatorId'] = undefined;

/**
 * GUID чата
 * @member {String} chatId
 */
InlineResponse20062.prototype['chatId'] = undefined;
 ...
 */
InlineResponse20062.prototype['monthlyProfit'] = undefined;

/**
 * Ежемесячная чистая прибыль
 * @member {Number} monthlyPureProfit
 */
InlineResponse20062.prototype['monthlyPureProfit'] = undefined;
 ...
 */
InlineResponse20062.prototype['shopLink'] = undefined;

/**
 * Массив активов
 * @member {Array.<String>} shopAssets
 */
InlineResponse20062.prototype['shopAssets'] = undefined;

/**
 * Массив возможностей
 * @member {Array.<String>} opportunities
 */
InlineResponse20062.prototype['opportunities'] = undefined;

/**
 * Массив рисков
 * @member {Array.<String>} risks
 */
InlineResponse20062.prototype['risks'] = undefined;

/**
 * Массив требуемых навыков
 * @member {Array.<String>} requiredSkills
 */
InlineResponse20062.prototype['requiredSkills'] = undefined;

/**
 * Поддержка продавца включает
 * @member {Array.<String>} sellIncludes
 */
InlineResponse20062.prototype['sellIncludes'] = undefined;

/**
 * Причины продажи
 * @member {Array.<String>} reasonForSale
 */
InlineResponse20062.prototype['reasonForSale'] = undefined;

/**
 * Дополнительная информация
 * @member {Array.<String>} additionalInfo
 */
InlineResponse20062.prototype['additionalInfo'] = undefined;
