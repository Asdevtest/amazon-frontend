...
class InlineObject48 {
    ...
    constructor(asin, images) { 
        ...
        InlineObject48.initialize(this, asin, images);
    }
 ...
 * @member {String} asin
 */
InlineObject48.prototype['asin'] = undefined;

/**
 * @member {Array.<String>} skusByClient
 */
InlineObject48.prototype['skusByClient'] = undefined;
 ...
 */
InlineObject48.prototype['currentSupplierId'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject48.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject48.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject48.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject48.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject48.prototype['amazon'] = undefined;
 ...
 */
InlineObject48.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject48.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject48.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject48.prototype['fbaamount'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject48.prototype['icomment'] = undefined;
 ...
 */
InlineObject48.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject48.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject48.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineObject48.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineObject48.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineObject48.prototype['chinaTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject48.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject48.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject48.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject48.prototype['margin'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject48.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject48.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject48.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject48.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject48.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject48.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject48.prototype['strategyStatus'] = undefined;

/**
 * Признак needCheckBySupervisor
 * @member {Boolean} needCheckBySupervisor
 */
InlineObject48.prototype['needCheckBySupervisor'] = undefined;

/**
 * hsCode продукта.
 * @member {String} hsCode
 */
InlineObject48.prototype['hsCode'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject48.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject48.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject48.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject48.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject48.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject48.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject48.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject48.prototype['avgReviews'] = undefined;

/**
 * Поле для калькуляции дозакупок
 * @member {Number} fourMonthesStock
 */
InlineObject48.prototype['fourMonthesStock'] = undefined;
