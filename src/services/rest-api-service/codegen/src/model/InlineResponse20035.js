...
import InlineResponse20035Details from './InlineResponse20035Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20025.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20035Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20025} request
 */
InlineResponse20035.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20035Details} details
 */
InlineResponse20035.prototype['details'] = undefined;
