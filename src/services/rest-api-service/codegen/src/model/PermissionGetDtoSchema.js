...
import InlineResponse2003AllowedUrls from './InlineResponse2003AllowedUrls';
...
class PermissionGetDtoSchema {
     ...
     * @param allowedUrls {Array.<module:model/InlineResponse2003AllowedUrls>} Массив доступных url.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allowedUrls')) {
                obj['allowedUrls'] = ApiClient.convertToType(data['allowedUrls'], [InlineResponse2003AllowedUrls]);
            }
 ...
 * @member {Array.<module:model/InlineResponse2003AllowedUrls>} allowedUrls
 */
