...
import InlineResponse20012AllowedUrls from './InlineResponse20012AllowedUrls';
...
class PermissionGetDtoSchema {
     ...
     * @param allowedUrls {Array.<module:model/InlineResponse20012AllowedUrls>} Массив доступных url.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allowedUrls')) {
                obj['allowedUrls'] = ApiClient.convertToType(data['allowedUrls'], [InlineResponse20012AllowedUrls]);
            }
 ...
 * @member {Array.<module:model/InlineResponse20012AllowedUrls>} allowedUrls
 */
