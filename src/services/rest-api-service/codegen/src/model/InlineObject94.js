...
class InlineObject94 {
    ...
    constructor(name, link, price, amount, minlot, comment, batchDeliveryCostInDollar) { 
        ...
        InlineObject94.initialize(this, name, link, price, amount, minlot, comment, batchDeliveryCostInDollar);
    }
 ...
 * @member {String} name
 */
InlineObject94.prototype['name'] = undefined;

/**
 * Ссылка на поставщика.
 * @member {String} link
 */
InlineObject94.prototype['link'] = undefined;

/**
 * Цена за еденицу, dollar
 * @member {Number} price
 */
InlineObject94.prototype['price'] = undefined;

/**
 * кол-во
 * @member {Number} amount
 */
InlineObject94.prototype['amount'] = undefined;

/**
 * Минимальный лот.
 * @member {Number} minlot
 */
InlineObject94.prototype['minlot'] = undefined;
 ...
 */
InlineObject94.prototype['yuanRate'] = undefined;

/**
 * Цена за еденицу, yuan
 * @member {Number} priceInYuan
 */
InlineObject94.prototype['priceInYuan'] = undefined;

/**
 * Доставка партии, dollar
 * @member {Number} batchDeliveryCostInDollar
 */
InlineObject94.prototype['batchDeliveryCostInDollar'] = undefined;

/**
 * Доставка партии, yuan
 * @member {Number} batchDeliveryCostInYuan
 */
InlineObject94.prototype['batchDeliveryCostInYuan'] = undefined;

/**
 * Цена партии, dollar
 * @member {Number} batchTotalCostInDollar
 */
InlineObject94.prototype['batchTotalCostInDollar'] = undefined;

/**
 * Цена партии, yuan
 * @member {Number} batchTotalCostInYuan
 */
InlineObject94.prototype['batchTotalCostInYuan'] = undefined;

/**
 * @member {Number} productionTerm
 */
InlineObject94.prototype['productionTerm'] = undefined;

/**
 * @member {module:model/ApiV1SuppliersBoxProperties} boxProperties
 */
InlineObject94.prototype['boxProperties'] = undefined;
