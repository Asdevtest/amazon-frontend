...
import InlineResponse20028Details from './InlineResponse20028Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20028Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20028.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20028Details} details
 */
InlineResponse20028.prototype['details'] = undefined;
