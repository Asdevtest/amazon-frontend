 ...
 */
InlineResponse20028.prototype['amount'] = undefined;
 ...
 */
InlineResponse20028.prototype['destination'] = undefined;

/**
 * @member {String} item
 */
InlineResponse20028.prototype['item'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineResponse20028.prototype['priceInYuan'] = undefined;

/**
 * Сумма частичной оплаты
 * @member {Number} partialPaymentAmountRmb
 */
InlineResponse20028.prototype['partialPaymentAmountRmb'] = undefined;

/**
 * Используется ли частичная оплата
 * @member {Boolean} partialPayment
 */
InlineResponse20028.prototype['partialPayment'] = undefined;

/**
 * Есть ли реквизиты в ордере
 * @member {Boolean} paymentDetailsAttached
 */
InlineResponse20028.prototype['paymentDetailsAttached'] = undefined;

/**
 * Cумма частичной оплаты
 * @member {Number} partiallyPaid
 */
InlineResponse20028.prototype['partiallyPaid'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersOrdersMyPayments>} payments
 */
InlineResponse20028.prototype['payments'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyOrderSupplier} orderSupplier
 */
InlineResponse20028.prototype['orderSupplier'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineResponse20028.PriorityEnum} priority
 */
 ...
 */
InlineResponse20028.prototype['expressChinaDelivery'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineResponse20028.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineResponse20028.prototype['deadline'] = undefined;

/**
 * Дата оплаты поставщтку
 * @member {String} paymentDateToSupplier
 */
InlineResponse20028.prototype['paymentDateToSupplier'] = undefined;

/**
 * Сумма оплаты $ за партию товара - это сумма в $ указывается закупщиком
 * @member {Number} totalPrice
 */
InlineResponse20028.prototype['totalPrice'] = undefined;
 ...
 */
InlineResponse20028.prototype['totalPriceChanged'] = undefined;
 ...
 */
InlineResponse20028.prototype['product'] = undefined;
 ...
 * @readonly
 */
InlineResponse20028['PriorityEnum'] = {
