 ...
 */
InlineResponse20028.prototype['bidderId'] = undefined;

/**
 * GUID модератора магазина
 * @member {String} moderatorId
 */
InlineResponse20028.prototype['moderatorId'] = undefined;

/**
 * GUID чата
 * @member {String} chatId
 */
InlineResponse20028.prototype['chatId'] = undefined;
 ...
 */
InlineResponse20028.prototype['files'] = undefined;
 ...
 */
InlineResponse20028.prototype['monthlyProfit'] = undefined;

/**
 * Ежемесячная чистая прибыль
 * @member {Number} monthlyPureProfit
 */
InlineResponse20028.prototype['monthlyPureProfit'] = undefined;

/**
 * Ежемесячный множитель
 * @member {Number} monthlyMultiplier
 */
InlineResponse20028.prototype['monthlyMultiplier'] = undefined;

/**
 * Статистика магазина по месяцам
 * @member {Array.<module:model/ApiV1ShopSellStatistics1>} statistics
 */
InlineResponse20028.prototype['statistics'] = undefined;

/**
 * Дата создания бизнеса
 * @member {Date} businessStartDate
 */
InlineResponse20028.prototype['businessStartDate'] = undefined;

/**
 * Детали магазина
 * @member {String} shopDetails
 */
InlineResponse20028.prototype['shopDetails'] = undefined;

/**
 * Ссылка магазина
 * @member {String} shopLink
 */
InlineResponse20028.prototype['shopLink'] = undefined;

/**
 * Массив активов
 * @member {Array.<String>} shopAssets
 */
InlineResponse20028.prototype['shopAssets'] = undefined;

/**
 * Массив возможностей
 * @member {Array.<String>} opportunities
 */
InlineResponse20028.prototype['opportunities'] = undefined;

/**
 * Массив рисков
 * @member {Array.<String>} risks
 */
InlineResponse20028.prototype['risks'] = undefined;

/**
 * Массив требуемых навыков
 * @member {Array.<String>} requiredSkills
 */
InlineResponse20028.prototype['requiredSkills'] = undefined;

/**
 * Поддержка продавца включает
 * @member {Array.<String>} sellIncludes
 */
InlineResponse20028.prototype['sellIncludes'] = undefined;

/**
 * Причины продажи
 * @member {Array.<String>} reasonForSale
 */
InlineResponse20028.prototype['reasonForSale'] = undefined;

/**
 * Дополнительная информация
 * @member {Array.<String>} additionalInfo
 */
InlineResponse20028.prototype['additionalInfo'] = undefined;
