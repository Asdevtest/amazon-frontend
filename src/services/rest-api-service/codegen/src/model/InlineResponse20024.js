...
class InlineResponse20024 {
    ...
    constructor(_id) { 
        ...
        InlineResponse20024.initialize(this, _id);
    }
 ...
 */
InlineResponse20024.prototype['tariffLogistics'] = undefined;

/**
 * Тарифы складов для сторкипера.
 * @member {Array.<module:model/ApiV1StorekeepersTariffWarehouses>} tariffWarehouses
 */
InlineResponse20024.prototype['tariffWarehouses'] = undefined;

/**
 * Количество коробок в сторкепере.
 * @member {Number} boxesCount
 */
InlineResponse20024.prototype['boxesCount'] = undefined;
