 ...
 */
InlineObject60.prototype['material'] = undefined;

/**
 * Признак fbm
 * @member {Boolean} fbm
 */
InlineObject60.prototype['fbm'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject60.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject60.prototype['lamazon'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lsupplier
 */
InlineObject60.prototype['lsupplier'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject60.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject60.prototype['fba'] = undefined;

/**
 *  уточнить 
 * @member {Boolean} express
 */
InlineObject60.prototype['express'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject60.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject60.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject60.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject60.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject60.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject60.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject60.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject60.prototype['fbaamount'] = undefined;

/**
 * @member {String} fbalink
 */
InlineObject60.prototype['fbalink'] = undefined;

/**
 * Стоимость доставки.
 * @member {Number} delivery
 */
InlineObject60.prototype['delivery'] = undefined;

/**
 *  Статус товара. У ресечера: 0 - новый товар. 5- готов к проверке супером. 10 - новый товар с поставщиком
 * @member {Number} status
 */
InlineObject60.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject60.prototype['icomment'] = undefined;

/**
 * Массив изображений.
 * @member {Array.<String>} images
 */
InlineObject60.prototype['images'] = undefined;

/**
 * @member {String} amazonDescription
 */
InlineObject60.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject60.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject60.prototype['amazonTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject60.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject60.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject60.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject60.prototype['margin'] = undefined;

/**
 * Цена
 * @member {Number} byboxprice
 */
InlineObject60.prototype['byboxprice'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject60.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject60.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject60.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject60.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject60.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject60.prototype['listingImages'] = undefined;

/**
 * 
 * @member {String} listingTaskToFindSupplier
 */
InlineObject60.prototype['listingTaskToFindSupplier'] = undefined;

/**
 * 
 * @member {String} listingSupplierImportantPoints
 */
InlineObject60.prototype['listingSupplierImportantPoints'] = undefined;

/**
 * 
 * @member {String} listingExtraInfo
 */
InlineObject60.prototype['listingExtraInfo'] = undefined;
 ...
 */
InlineObject60.prototype['listingSupplierCompetitors'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject60.prototype['strategyStatus'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject60.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject60.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject60.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject60.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject60.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject60.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject60.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject60.prototype['avgReviews'] = undefined;
