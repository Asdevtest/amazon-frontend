...
import InlineResponse20034Details from './InlineResponse20034Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20024.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20034Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20024} request
 */
InlineResponse20034.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20034Details} details
 */
