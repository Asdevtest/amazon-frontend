    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20022.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20032Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20022} request
 */
InlineResponse20032.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20032Details} details
 */
InlineResponse20032.prototype['details'] = undefined;
