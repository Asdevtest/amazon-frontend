...
class InlineObject10 {
    ...
    constructor(items) { 
        ...
        InlineObject10.initialize(this, items);
    }
 ...
 */
InlineObject10.prototype['isDraft'] = undefined;
 ...
 */
InlineObject10.prototype['trackNumberText'] = undefined;

/**
 * @member {Array.<String>} trackNumberFile
 */
InlineObject10.prototype['trackNumberFile'] = undefined;

/**
 * Идентификатор UPS
 * @member {String} upsTrackNumber
 */
InlineObject10.prototype['upsTrackNumber'] = undefined;
 ...
 */
InlineObject10.prototype['lengthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} widthCmWarehouse
 */
InlineObject10.prototype['widthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} heightCmWarehouse
 */
InlineObject10.prototype['heightCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} weighGrossKgWarehouse
 */
InlineObject10.prototype['weighGrossKgWarehouse'] = undefined;
 ...
 */
InlineObject10.prototype['isShippingLabelAttachedByStorekeeper'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} clientComment
 */
InlineObject10.prototype['clientComment'] = undefined;

/**
 * Дополнительное поле shippingLabel для доставки грузовиками
 * @member {String} referenceId
 */
InlineObject10.prototype['referenceId'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} storekeeperComment
 */
InlineObject10.prototype['storekeeperComment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaShipment
 */
InlineObject10.prototype['fbaShipment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaNumber
 */
InlineObject10.prototype['fbaNumber'] = undefined;

/**
 * Массив коробок.
 * @member {Array.<module:model/ApiV1BoxesItems>} items
 */
InlineObject10.prototype['items'] = undefined;

/**
 * Массив ссылок на фотографии.
 * @member {Array.<String>} images
 */
InlineObject10.prototype['images'] = undefined;

/**
 * destination GUID 
 * @member {String} destinationId
 */
InlineObject10.prototype['destinationId'] = undefined;

/**
 *  logicsTariff GUID
 * @member {String} logicsTariffId
 */
InlineObject10.prototype['logicsTariffId'] = undefined;

/**
 * Гуид вариации
 * @member {String} variationTariffId
 */
InlineObject10.prototype['variationTariffId'] = undefined;

/**
 * Значение информационного ключа
 * @member {String} prepId
 */
InlineObject10.prototype['prepId'] = undefined;
