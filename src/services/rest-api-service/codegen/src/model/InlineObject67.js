 ...
 */
InlineObject67.prototype['orderSupplierId'] = undefined;

/**
 * Склад для изменения
 * @member {String} storekeeperId
 */
InlineObject67.prototype['storekeeperId'] = undefined;

/**
 * Пункт назначения
 * @member {String} destinationId
 */
InlineObject67.prototype['destinationId'] = undefined;

/**
 * Тариф для изменения
 * @member {String} logicsTariffId
 */
InlineObject67.prototype['logicsTariffId'] = undefined;
 ...
 */
InlineObject67.prototype['totalPrice'] = undefined;

/**
 * Комментарий баера
 * @member {String} buyerComment
 */
InlineObject67.prototype['buyerComment'] = undefined;

/**
 * Не настоящий ключ, используется только для нужд юзера
 * @member {String} item
 */
InlineObject67.prototype['item'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineObject67.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineObject67.prototype['deadline'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineObject67.PriorityEnum} priority
 */
InlineObject67.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineObject67.prototype['expressChinaDelivery'] = undefined;

/**
 * Комментарий клтента в заказе
 * @member {String} clientComment
 */
InlineObject67.prototype['clientComment'] = undefined;
 ...
 */
InlineObject67.prototype['priceBatchDeliveryInYuan'] = undefined;
