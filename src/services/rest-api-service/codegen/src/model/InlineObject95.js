 ...
 */
InlineObject95.prototype['businessStartDate'] = undefined;

/**
 * Детали магазина
 * @member {String} shopDetails
 */
InlineObject95.prototype['shopDetails'] = undefined;

/**
 * Активы магазина
 * @member {Array.<String>} shopAssets
 */
InlineObject95.prototype['shopAssets'] = undefined;

/**
 * Файлы, которые привязаны к магазину (Пока заглушка, потом можно будет отправлят файлы, сейчас - ссылки)
 * @member {Array.<String>} files
 */
InlineObject95.prototype['files'] = undefined;

/**
 * Ссылка на сайт магазина
 * @member {String} shopLink
 */
InlineObject95.prototype['shopLink'] = undefined;

/**
 * Статистика магазина по месяцам
 * @member {Array.<module:model/ApiV1ShopSellStatistics1>} statistics
 */
InlineObject95.prototype['statistics'] = undefined;

/**
 * Возможности магазина
 * @member {Array.<String>} opportunities
 */
InlineObject95.prototype['opportunities'] = undefined;

/**
 * Риски магазина
 * @member {Array.<String>} risks
 */
InlineObject95.prototype['risks'] = undefined;

/**
 * Требуемые навыки
 * @member {Array.<String>} requiredSkills
 */
InlineObject95.prototype['requiredSkills'] = undefined;

/**
 * В продажу также включено
 * @member {Array.<String>} sellIncludes
 */
InlineObject95.prototype['sellIncludes'] = undefined;

/**
 * Причина продажи
 * @member {Array.<String>} reasonForSale
 */
InlineObject95.prototype['reasonForSale'] = undefined;

/**
 * Дополнительная информация
 * @member {Array.<String>} additionalInfo
 */
InlineObject95.prototype['additionalInfo'] = undefined;
