...
/**
 * The ApiV1AdminsOrdersCreatedBy model module.
 * @module model/ApiV1AdminsOrdersCreatedBy
 * @version 0.1.0
 */
class ApiV1AdminsOrdersCreatedBy {
     ...
     * @param role {Number} Код роли присвоенный пользователю.    roles.root = 0    roles.client = 10    roles.super = 20    roles.researcher = 30    roles.freelancer = 35    roles.buyer = 40    roles.candidate = 50    
 ...
 * @member {String} _id
 */
ApiV1AdminsOrdersCreatedBy.prototype['_id'] = undefined;

/**
 * Имя пользователя.
 * @member {String} name
 */
ApiV1AdminsOrdersCreatedBy.prototype['name'] = undefined;

/**
 * email
 * @member {String} email
 */
ApiV1AdminsOrdersCreatedBy.prototype['email'] = undefined;

/**
 * Код роли присвоенный пользователю.    roles.root = 0    roles.client = 10    roles.super = 20    roles.researcher = 30    roles.freelancer = 35    roles.buyer = 40    roles.candidate = 50    
 * @member {Number} role
 */
ApiV1AdminsOrdersCreatedBy.prototype['role'] = undefined;

/**
 * Флаг fba.
 * @member {Boolean} fba
 */
ApiV1AdminsOrdersCreatedBy.prototype['fba'] = undefined;

/**
 * Если истина - пользователь активен. Если нет - заблокирован админом.
 * @member {Boolean} active
 */
ApiV1AdminsOrdersCreatedBy.prototype['active'] = undefined;
