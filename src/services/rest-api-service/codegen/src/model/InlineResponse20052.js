...
import InlineResponse20052Details from './InlineResponse20052Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20041.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20052Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20041} request
 */
InlineResponse20052.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20052Details} details
 */
