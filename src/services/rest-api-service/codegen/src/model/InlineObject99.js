 ...
 */
InlineObject99.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject99.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject99.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject99.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject99.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject99.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject99.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject99.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject99.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject99.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject99.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject99.prototype['fbaamount'] = undefined;

/**
 *  Статус товара. У ресечера: 0 - новый товар. 5- готов к проверке супером. 10 - новый товар с поставщиком
 * @member {Number} status
 */
InlineObject99.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject99.prototype['icomment'] = undefined;
 ...
 */
InlineObject99.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject99.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject99.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineObject99.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineObject99.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineObject99.prototype['chinaTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject99.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject99.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject99.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject99.prototype['margin'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject99.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject99.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject99.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject99.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject99.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject99.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject99.prototype['strategyStatus'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject99.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject99.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject99.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject99.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject99.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject99.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject99.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject99.prototype['avgReviews'] = undefined;

/**
 * @member {Array.<module:model/ApiV1ClientsProductsGuidRedFlags>} redFlags
 */
InlineObject99.prototype['redFlags'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersProductsGuidTags>} tags
 */
InlineObject99.prototype['tags'] = undefined;
