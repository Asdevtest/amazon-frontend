...
class InlineObject20 {
    ...
    constructor(items) { 
        ...
        InlineObject20.initialize(this, items);
    }
 ...
 */
InlineObject20.prototype['isDraft'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} lengthCmSupplier
 */
InlineObject20.prototype['lengthCmSupplier'] = undefined;

/**
 * Текст трек номера
 * @member {String} trackNumberText
 */
InlineObject20.prototype['trackNumberText'] = undefined;

/**
 * @member {Array.<String>} trackNumberFile
 */
InlineObject20.prototype['trackNumberFile'] = undefined;

/**
 * Идентификатор UPS
 * @member {String} upsTrackNumber
 */
InlineObject20.prototype['upsTrackNumber'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} widthCmSupplier
 */
InlineObject20.prototype['widthCmSupplier'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} heightCmSupplier
 */
InlineObject20.prototype['heightCmSupplier'] = undefined;

/**
 * Общий вес кг коробки который назвал поставщик.
 * @member {Number} weighGrossKgSupplier
 */
InlineObject20.prototype['weighGrossKgSupplier'] = undefined;
 ...
 */
InlineObject20.prototype['referenceId'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} storekeeperComment
 */
InlineObject20.prototype['storekeeperComment'] = undefined;
 ...
 */
InlineObject20.prototype['items'] = undefined;
 ...
 */
InlineObject20.prototype['variationTariffId'] = undefined;

/**
 * Значение информационного ключа
 * @member {String} prepId
 */
InlineObject20.prototype['prepId'] = undefined;
