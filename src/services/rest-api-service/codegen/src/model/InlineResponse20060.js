 ...
 * @member {String} type
 */
InlineResponse20060.prototype['type'] = undefined;

/**
 * Заявка без подтверждения
 * @member {Boolean} withoutConfirmation
 */
InlineResponse20060.prototype['withoutConfirmation'] = undefined;
 ...
 * @member {module:model/InlineResponse20060.StatusEnum} status
 */
 ...
 */
InlineResponse20060.prototype['timeoutAt'] = undefined;

/**
 * Время за которое должен отправить предложение после бронирования. В минутах.
 * @member {Number} timeLimitInMinutes
 */
InlineResponse20060.prototype['timeLimitInMinutes'] = undefined;

/**
 * Массив id пользователей.
 * @member {Array.<String>} assignees
 */
InlineResponse20060.prototype['assignees'] = undefined;

/**
 * Направление заявки, исходящая или входящая.
 * @member {module:model/InlineResponse20060.DirectionEnum} direction
 */
InlineResponse20060.prototype['direction'] = undefined;

/**
 * Массив массив ролей.
 * @member {Array.<Number>} roles
 */
InlineResponse20060.prototype['roles'] = undefined;

/**
 * Если требуется проверка супервайзером.
 * @member {Boolean} needCheckBySupervisor
 */
InlineResponse20060.prototype['needCheckBySupervisor'] = undefined;

/**
 * Запретить фрилансеру повторное отправление предложений.
 * @member {Boolean} restrictMoreThanOneProposalFromOneAssignee
 */
InlineResponse20060.prototype['restrictMoreThanOneProposalFromOneAssignee'] = undefined;
 ...
 */
InlineResponse20060.prototype['productId'] = undefined;

/**
 * Привязанный асин
 * @member {String} asin
 */
InlineResponse20060.prototype['asin'] = undefined;

/**
 * Цена на амазоне
 * @member {Number} priceAmazon
 */
InlineResponse20060.prototype['priceAmazon'] = undefined;

/**
 * Возврат средств с покупки в процентах
 * @member {Number} cashBackInPercent
 */
InlineResponse20060.prototype['cashBackInPercent'] = undefined;

/**
 * Гуид анонса
 * @member {String} announcementId
 */
InlineResponse20060.prototype['announcementId'] = undefined;
 ...
 * @readonly
 */
InlineResponse20060['StatusEnum'] = {
 ...
 * @readonly
 */
InlineResponse20060['DirectionEnum'] = {
