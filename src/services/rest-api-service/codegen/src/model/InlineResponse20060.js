 ...
 */
InlineResponse20060.prototype['owner'] = undefined;

/**
 * GUID покупателя магазина
 * @member {String} bidderId
 */
InlineResponse20060.prototype['bidderId'] = undefined;

/**
 * GUID модератора магазина
 * @member {String} moderatorId
 */
InlineResponse20060.prototype['moderatorId'] = undefined;

/**
 * GUID чата
 * @member {String} chatId
 */
InlineResponse20060.prototype['chatId'] = undefined;
 ...
 */
InlineResponse20060.prototype['files'] = undefined;
 ...
 */
InlineResponse20060.prototype['monthlyProfit'] = undefined;

/**
 * Ежемесячная чистая прибыль
 * @member {Number} monthlyPureProfit
 */
InlineResponse20060.prototype['monthlyPureProfit'] = undefined;

/**
 * Ежемесячный множитель
 * @member {Number} monthlyMultiplier
 */
InlineResponse20060.prototype['monthlyMultiplier'] = undefined;

/**
 * Статистика магазина по месяцам
 * @member {Array.<module:model/ApiV1ShopSellStatistics1>} statistics
 */
InlineResponse20060.prototype['statistics'] = undefined;

/**
 * Дата создания бизнеса
 * @member {Date} businessStartDate
 */
InlineResponse20060.prototype['businessStartDate'] = undefined;

/**
 * Детали магазина
 * @member {String} shopDetails
 */
InlineResponse20060.prototype['shopDetails'] = undefined;

/**
 * Ссылка магазина
 * @member {String} shopLink
 */
InlineResponse20060.prototype['shopLink'] = undefined;

/**
 * Массив активов
 * @member {Array.<String>} shopAssets
 */
InlineResponse20060.prototype['shopAssets'] = undefined;

/**
 * Массив возможностей
 * @member {Array.<String>} opportunities
 */
InlineResponse20060.prototype['opportunities'] = undefined;

/**
 * Массив рисков
 * @member {Array.<String>} risks
 */
InlineResponse20060.prototype['risks'] = undefined;

/**
 * Массив требуемых навыков
 * @member {Array.<String>} requiredSkills
 */
InlineResponse20060.prototype['requiredSkills'] = undefined;

/**
 * Поддержка продавца включает
 * @member {Array.<String>} sellIncludes
 */
InlineResponse20060.prototype['sellIncludes'] = undefined;

/**
 * Причины продажи
 * @member {Array.<String>} reasonForSale
 */
InlineResponse20060.prototype['reasonForSale'] = undefined;

/**
 * Дополнительная информация
 * @member {Array.<String>} additionalInfo
 */
InlineResponse20060.prototype['additionalInfo'] = undefined;
