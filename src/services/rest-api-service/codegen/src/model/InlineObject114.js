...
import ApiV1StorekeepersTasksDoneGuidItems from './ApiV1StorekeepersTasksDoneGuidItems';
...
class InlineObject114 {
     ...
     * @param items {Array.<module:model/ApiV1StorekeepersTasksDoneGuidItems>} Массив коробок.
     */
    constructor(items) { 
        
        InlineObject114.initialize(this, items);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ApiV1StorekeepersTasksDoneGuidItems]);
            }
 ...
 */
InlineObject114.prototype['amount'] = undefined;

/**
 * true - если создаем черновик заказа.
 * @member {Boolean} isDraft
 */
InlineObject114.prototype['isDraft'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} lengthCmSupplier
 */
InlineObject114.prototype['lengthCmSupplier'] = undefined;

/**
 * Текст трек номера
 * @member {String} trackNumberText
 */
InlineObject114.prototype['trackNumberText'] = undefined;

/**
 * @member {Array.<String>} trackNumberFile
 */
InlineObject114.prototype['trackNumberFile'] = undefined;

/**
 * Идентификатор UPS
 * @member {String} upsTrackNumber
 */
InlineObject114.prototype['upsTrackNumber'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} widthCmSupplier
 */
InlineObject114.prototype['widthCmSupplier'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} heightCmSupplier
 */
InlineObject114.prototype['heightCmSupplier'] = undefined;

/**
 * Общий вес кг коробки который назвал поставщик.
 * @member {Number} weighGrossKgSupplier
 */
InlineObject114.prototype['weighGrossKgSupplier'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} lengthCmWarehouse
 */
InlineObject114.prototype['lengthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} widthCmWarehouse
 */
InlineObject114.prototype['widthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} heightCmWarehouse
 */
InlineObject114.prototype['heightCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} weighGrossKgWarehouse
 */
InlineObject114.prototype['weighGrossKgWarehouse'] = undefined;
 ...
 */
InlineObject114.prototype['isShippingLabelAttachedByStorekeeper'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} clientComment
 */
InlineObject114.prototype['clientComment'] = undefined;

/**
 * Дополнительное поле shippingLabel для доставки грузовиками
 * @member {String} referenceId
 */
InlineObject114.prototype['referenceId'] = undefined;
 ...
 */
InlineObject114.prototype['fbaShipment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaNumber
 */
InlineObject114.prototype['fbaNumber'] = undefined;

/**
 * Массив коробок.
 * @member {Array.<module:model/ApiV1StorekeepersTasksDoneGuidItems>} items
 */
InlineObject114.prototype['items'] = undefined;
 ...
 */
InlineObject114.prototype['destinationId'] = undefined;

/**
 * GUID тарифа доставки 
 * @member {String} logicsTariffId
 */
InlineObject114.prototype['logicsTariffId'] = undefined;

/**
 * Гуид вариации
 * @member {String} variationTariffId
 */
InlineObject114.prototype['variationTariffId'] = undefined;

/**
 * Значение информационного ключа
 * @member {String} prepId
 */
InlineObject114.prototype['prepId'] = undefined;

/**
 * GUID сторкипера
 * @member {String} storekeeperId
 */
InlineObject114.prototype['storekeeperId'] = undefined;
