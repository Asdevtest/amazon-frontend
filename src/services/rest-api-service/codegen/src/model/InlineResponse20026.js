 ...
 */
InlineResponse20026.prototype['amount'] = undefined;
 ...
 */
InlineResponse20026.prototype['buyerComment'] = undefined;

/**
 * @member {module:model/ApiV1AdminsOrdersDestination} destination
 */
InlineResponse20026.prototype['destination'] = undefined;

/**
 * @member {String} item
 */
InlineResponse20026.prototype['item'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineResponse20026.prototype['priceInYuan'] = undefined;

/**
 * Сумма частичной оплаты
 * @member {Number} partialPaymentAmountRmb
 */
InlineResponse20026.prototype['partialPaymentAmountRmb'] = undefined;

/**
 * Используется ли частичная оплата
 * @member {Boolean} partialPayment
 */
InlineResponse20026.prototype['partialPayment'] = undefined;

/**
 * Есть ли реквизиты в ордере
 * @member {Boolean} paymentDetailsAttached
 */
InlineResponse20026.prototype['paymentDetailsAttached'] = undefined;

/**
 * Cумма частичной оплаты
 * @member {Number} partiallyPaid
 */
InlineResponse20026.prototype['partiallyPaid'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersOrdersMyPayments>} payments
 */
InlineResponse20026.prototype['payments'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyOrderSupplier} orderSupplier
 */
InlineResponse20026.prototype['orderSupplier'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineResponse20026.PriorityEnum} priority
 */
InlineResponse20026.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineResponse20026.prototype['expressChinaDelivery'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineResponse20026.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineResponse20026.prototype['deadline'] = undefined;

/**
 * Дата оплаты поставщтку
 * @member {String} paymentDateToSupplier
 */
InlineResponse20026.prototype['paymentDateToSupplier'] = undefined;

/**
 * Сумма оплаты $ за партию товара - это сумма в $ указывается закупщиком
 * @member {Number} totalPrice
 */
InlineResponse20026.prototype['totalPrice'] = undefined;
 ...
 */
InlineResponse20026.prototype['totalPriceChanged'] = undefined;
 ...
 */
InlineResponse20026.prototype['storekeeper'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyProduct} product
 */
InlineResponse20026.prototype['product'] = undefined;
 ...
 * @readonly
 */
InlineResponse20026['PriorityEnum'] = {
