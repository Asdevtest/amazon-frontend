 ...
 */
InlineObject69.prototype['amount'] = undefined;

/**
 * Гуид сапплаера
 * @member {String} orderSupplierId
 */
InlineObject69.prototype['orderSupplierId'] = undefined;

/**
 * Склад для изменения
 * @member {String} storekeeperId
 */
InlineObject69.prototype['storekeeperId'] = undefined;

/**
 * Пункт назначения
 * @member {String} destinationId
 */
InlineObject69.prototype['destinationId'] = undefined;

/**
 * Тариф для изменения
 * @member {String} logicsTariffId
 */
InlineObject69.prototype['logicsTariffId'] = undefined;
 ...
 */
InlineObject69.prototype['totalPrice'] = undefined;
 ...
 * @member {String} item
 */
InlineObject69.prototype['item'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineObject69.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineObject69.prototype['deadline'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineObject69.PriorityEnum} priority
 */
InlineObject69.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineObject69.prototype['expressChinaDelivery'] = undefined;

/**
 * Комментарий клтента в заказе
 * @member {String} clientComment
 */
InlineObject69.prototype['clientComment'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineObject69.prototype['priceInYuan'] = undefined;

/**
 * Цена доставки партии в юанях
 * @member {Number} priceBatchDeliveryInYuan
 */
InlineObject69.prototype['priceBatchDeliveryInYuan'] = undefined;
