...
class InlineObject24 {
    ...
    constructor(items) { 
        ...
        InlineObject24.initialize(this, items);
    }
 ...
 */
InlineObject24.prototype['widthCmSupplier'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} heightCmSupplier
 */
InlineObject24.prototype['heightCmSupplier'] = undefined;

/**
 * Общий вес кг коробки который назвал поставщик.
 * @member {Number} weighGrossKgSupplier
 */
InlineObject24.prototype['weighGrossKgSupplier'] = undefined;
 ...
 */
InlineObject24.prototype['items'] = undefined;
