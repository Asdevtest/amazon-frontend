 ...
 */
InlineObject49.prototype['material'] = undefined;

/**
 * Признак fbm
 * @member {Boolean} fbm
 */
InlineObject49.prototype['fbm'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject49.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject49.prototype['lamazon'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lsupplier
 */
InlineObject49.prototype['lsupplier'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject49.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject49.prototype['fba'] = undefined;

/**
 *  уточнить 
 * @member {Boolean} express
 */
InlineObject49.prototype['express'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject49.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject49.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject49.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject49.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject49.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject49.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject49.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject49.prototype['fbaamount'] = undefined;

/**
 * @member {String} fbalink
 */
InlineObject49.prototype['fbalink'] = undefined;

/**
 * Стоимость доставки.
 * @member {Number} delivery
 */
InlineObject49.prototype['delivery'] = undefined;

/**
 * См. описание статусов например в readMe.md
 * @member {Number} status
 */
InlineObject49.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject49.prototype['icomment'] = undefined;
 ...
 */
InlineObject49.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject49.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject49.prototype['amazonTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject49.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject49.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject49.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject49.prototype['margin'] = undefined;

/**
 * Цена
 * @member {Number} byboxprice
 */
InlineObject49.prototype['byboxprice'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject49.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject49.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject49.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject49.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject49.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject49.prototype['listingImages'] = undefined;

/**
 * 
 * @member {String} listingTaskToFindSupplier
 */
InlineObject49.prototype['listingTaskToFindSupplier'] = undefined;

/**
 * 
 * @member {String} listingSupplierImportantPoints
 */
InlineObject49.prototype['listingSupplierImportantPoints'] = undefined;

/**
 * 
 * @member {String} listingExtraInfo
 */
InlineObject49.prototype['listingExtraInfo'] = undefined;
 ...
 */
InlineObject49.prototype['listingSupplierCompetitors'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject49.prototype['strategyStatus'] = undefined;

/**
 * Комментарий к статусу проверки.
 * @member {String} checkednotes
 */
InlineObject49.prototype['checkednotes'] = undefined;
