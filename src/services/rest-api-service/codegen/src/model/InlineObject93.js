...
class InlineObject93 {
    ...
    constructor(asin, lamazon) { 
        ...
        InlineObject93.initialize(this, asin, lamazon);
    }
 ...
 * @member {String} asin
 */
InlineObject93.prototype['asin'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject93.prototype['lamazon'] = undefined;

/**
 * GUID поставщика
 * @member {String} currentSupplierId
 */
InlineObject93.prototype['currentSupplierId'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject93.prototype['category'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject93.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject93.prototype['fba'] = undefined;

/**
 *  Статус товара. У ресечера: 0 - новый товар.  10 - новый товар с поставщиком
 * @member {Number} status
 */
InlineObject93.prototype['status'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject93.prototype['amazon'] = undefined;

/**
 * Массив поставщиков.
 * @member {Array.<String>} suppliersIds
 */
InlineObject93.prototype['suppliersIds'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject93.prototype['fbafee'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject93.prototype['icomment'] = undefined;
 ...
 */
InlineObject93.prototype['reffee'] = undefined;
 ...
 * @member {String} niche
 */
InlineObject93.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject93.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject93.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject93.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject93.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject93.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject93.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject93.prototype['avgReviews'] = undefined;

/**
 * Дополнительная инфа для дозакупок
 * @member {Number} fourMonthesStock
 */
InlineObject93.prototype['fourMonthesStock'] = undefined;

/**
 * ID магазинов для продукта
 * @member {Array.<String>} shopIds
 */
InlineObject93.prototype['shopIds'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersProductsGuidTags>} tags
 */
InlineObject93.prototype['tags'] = undefined;
