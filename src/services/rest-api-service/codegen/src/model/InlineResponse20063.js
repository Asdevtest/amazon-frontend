...
import InlineResponse20063Details from './InlineResponse20063Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20063Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20063Details} details
 */
