...
class ApiV1SuppliersBoxProperties {
     ...
     */
    constructor(boxLengthCm, boxWidthCm, boxHeightCm, boxWeighGrossKg) { 
        
        ApiV1SuppliersBoxProperties.initialize(this, boxLengthCm, boxWidthCm, boxHeightCm, boxWeighGrossKg);
    }
     ...
     */
    static initialize(obj, boxLengthCm, boxWidthCm, boxHeightCm, boxWeighGrossKg) { 
