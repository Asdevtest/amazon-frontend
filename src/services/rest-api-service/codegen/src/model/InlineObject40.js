 ...
 * @member {String} asin
 */
InlineObject40.prototype['asin'] = undefined;

/**
 * @member {Array.<String>} skusByClient
 */
InlineObject40.prototype['skusByClient'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject40.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject40.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject40.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject40.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject40.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject40.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject40.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject40.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject40.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject40.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject40.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject40.prototype['fbaamount'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject40.prototype['icomment'] = undefined;
 ...
 */
InlineObject40.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject40.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject40.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineObject40.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineObject40.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineObject40.prototype['chinaTitle'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject40.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject40.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject40.prototype['margin'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject40.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject40.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject40.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject40.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject40.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject40.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject40.prototype['strategyStatus'] = undefined;

/**
 * Признак needCheckBySupervisor
 * @member {Boolean} needCheckBySupervisor
 */
InlineObject40.prototype['needCheckBySupervisor'] = undefined;

/**
 * Флаг указывает что продукт в архиве.
 * @member {Boolean} archive
 */
InlineObject40.prototype['archive'] = undefined;

/**
 * hsCode продукта.
 * @member {String} hsCode
 */
InlineObject40.prototype['hsCode'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject40.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject40.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject40.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject40.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject40.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject40.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject40.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject40.prototype['avgReviews'] = undefined;

/**
 * Поле для калькуляции дозакупок
 * @member {Number} fourMonthesStock
 */
InlineObject40.prototype['fourMonthesStock'] = undefined;

/**
 * ID магазинов для продукта
 * @member {Array.<String>} shopIds
 */
InlineObject40.prototype['shopIds'] = undefined;
