...
import InlineResponse20010Rows from './InlineResponse20010Rows';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rows')) {
                obj['rows'] = ApiClient.convertToType(data['rows'], [InlineResponse20010Rows]);
            }
...
/**
 * @member {Array.<module:model/InlineResponse20010Rows>} rows
 */
InlineResponse20010.prototype['rows'] = undefined;
