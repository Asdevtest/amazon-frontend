...
/**
 * The ApiV1AdminsGetProductsByStatusClient model module.
 * @module model/ApiV1AdminsGetProductsByStatusClient
 * @version 0.1.0
 */
class ApiV1AdminsGetProductsByStatusClient {
    ...
    /**
     * Constructs a <code>ApiV1AdminsGetProductsByStatusClient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1AdminsGetProductsByStatusClient} obj Optional instance to populate.
     * @return {module:model/ApiV1AdminsGetProductsByStatusClient} The populated <code>ApiV1AdminsGetProductsByStatusClient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1AdminsGetProductsByStatusClient();
...
export default ApiV1AdminsGetProductsByStatusClient;
