...
class InlineObject11 {
    ...
    constructor(items) { 
        ...
        InlineObject11.initialize(this, items);
    }
 ...
 */
InlineObject11.prototype['amount'] = undefined;

/**
 * true - если создаем черновик заказа.
 * @member {Boolean} isDraft
 */
InlineObject11.prototype['isDraft'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} lengthCmSupplier
 */
InlineObject11.prototype['lengthCmSupplier'] = undefined;

/**
 * Текст трек номера
 * @member {String} trackNumberText
 */
InlineObject11.prototype['trackNumberText'] = undefined;

/**
 * @member {Array.<String>} trackNumberFile
 */
InlineObject11.prototype['trackNumberFile'] = undefined;

/**
 * Идентификатор UPS
 * @member {String} upsTrackNumber
 */
InlineObject11.prototype['upsTrackNumber'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} widthCmSupplier
 */
InlineObject11.prototype['widthCmSupplier'] = undefined;

/**
 * Размеры которые назвал поставщик при заказе ( могут отличаться с реальными).
 * @member {Number} heightCmSupplier
 */
InlineObject11.prototype['heightCmSupplier'] = undefined;

/**
 * Общий вес кг коробки который назвал поставщик.
 * @member {Number} weighGrossKgSupplier
 */
InlineObject11.prototype['weighGrossKgSupplier'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} lengthCmWarehouse
 */
InlineObject11.prototype['lengthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} widthCmWarehouse
 */
InlineObject11.prototype['widthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} heightCmWarehouse
 */
InlineObject11.prototype['heightCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} weighGrossKgWarehouse
 */
InlineObject11.prototype['weighGrossKgWarehouse'] = undefined;
 ...
 */
InlineObject11.prototype['isShippingLabelAttachedByStorekeeper'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} clientComment
 */
InlineObject11.prototype['clientComment'] = undefined;

/**
 * Дополнительное поле shippingLabel для доставки грузовиками
 * @member {String} referenceId
 */
InlineObject11.prototype['referenceId'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} storekeeperComment
 */
InlineObject11.prototype['storekeeperComment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaShipment
 */
InlineObject11.prototype['fbaShipment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaNumber
 */
InlineObject11.prototype['fbaNumber'] = undefined;

/**
 * Массив коробок.
 * @member {Array.<module:model/ApiV1BoxesItems>} items
 */
InlineObject11.prototype['items'] = undefined;
 ...
 */
InlineObject11.prototype['destinationId'] = undefined;

/**
 * GUID тарифа доставки 
 * @member {String} logicsTariffId
 */
InlineObject11.prototype['logicsTariffId'] = undefined;

/**
 * Гуид вариации
 * @member {String} variationTariffId
 */
InlineObject11.prototype['variationTariffId'] = undefined;

/**
 * Значение информационного ключа
 * @member {String} prepId
 */
InlineObject11.prototype['prepId'] = undefined;

/**
 * GUID сторкипера
 * @member {String} storekeeperId
 */
InlineObject11.prototype['storekeeperId'] = undefined;
