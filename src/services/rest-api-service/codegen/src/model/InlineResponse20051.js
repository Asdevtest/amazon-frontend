 ...
 */
InlineResponse20051.prototype['skusByClient'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusSuppliers>} suppliers
 */
InlineResponse20051.prototype['suppliers'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusSuppliers} currentSupplier
 */
InlineResponse20051.prototype['currentSupplier'] = undefined;

/**
 * GUID поставщика в базе данных
 * @member {String} currentSupplierId
 */
InlineResponse20051.prototype['currentSupplierId'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineResponse20051.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineResponse20051.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineResponse20051.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineResponse20051.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineResponse20051.prototype['amazon'] = undefined;
 ...
 * @member {Number} width
 */
InlineResponse20051.prototype['width'] = undefined;

/**
 * Длинна
 * @member {Number} length
 */
InlineResponse20051.prototype['length'] = undefined;

/**
 * Вес
 * @member {Number} weight
 */
InlineResponse20051.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineResponse20051.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineResponse20051.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineResponse20051.prototype['fbaamount'] = undefined;
 ...
 */
InlineResponse20051.prototype['icomment'] = undefined;

/**
 * Комментарии к товару, от клиента.
 * @member {String} clientComment
 */
InlineResponse20051.prototype['clientComment'] = undefined;

/**
 * Массив картинок.
 * @member {Array.<String>} images
 */
InlineResponse20051.prototype['images'] = undefined;

/**
 * Цена для клиента
 * @member {Number} priceForClient
 */
InlineResponse20051.prototype['priceForClient'] = undefined;

/**
 * 
 * @member {String} checkednotes
 */
InlineResponse20051.prototype['checkednotes'] = undefined;

/**
 * Признак isCreatedByClient
 * @member {Boolean} isCreatedByClient
 */
InlineResponse20051.prototype['isCreatedByClient'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} client
 */
InlineResponse20051.prototype['client'] = undefined;

/**
 * Описание с сайта амазон.
 * @member {String} amazonDescription
 */
InlineResponse20051.prototype['amazonDescription'] = undefined;

/**
 * Данные из поля детали с сайта амазон.
 * @member {String} amazonDetail
 */
InlineResponse20051.prototype['amazonDetail'] = undefined;

/**
 * Заголовок на товар с сайта амазон.
 * @member {String} amazonTitle
 */
InlineResponse20051.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineResponse20051.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineResponse20051.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineResponse20051.prototype['chinaTitle'] = undefined;

/**
 * Баркод
 * @member {String} barCode
 */
InlineResponse20051.prototype['barCode'] = undefined;

/**
 * Минимальный заказ
 * @member {Number} minpurchase
 */
InlineResponse20051.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineResponse20051.prototype['profit'] = undefined;
 ...
 */
InlineResponse20051.prototype['inTransfer'] = undefined;
 ...
 */
InlineResponse20051.prototype['checkedBy'] = undefined;
 ...
 */
InlineResponse20051.prototype['checkedAt'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} buyer
 */
InlineResponse20051.prototype['buyer'] = undefined;

/**
 * Дедлаин на на поиск поставщика байером.
 * @member {Date} buyerTimeoutAt
 */
InlineResponse20051.prototype['buyerTimeoutAt'] = undefined;

/**
 * Комментарии к товару от байера.
 * @member {String} buyersComment
 */
InlineResponse20051.prototype['buyersComment'] = undefined;

/**
 * ID магазинов для продукта
 * @member {Array.<String>} shopIds
 */
InlineResponse20051.prototype['shopIds'] = undefined;

/**
 * Савка ресечера.
 * @member {Number} researcherRate
 */
InlineResponse20051.prototype['researcherRate'] = undefined;

/**
 * Савка супервайзера.
 * @member {Number} supervisorRate
 */
InlineResponse20051.prototype['supervisorRate'] = undefined;

/**
 * Дата оплаты
 * @member {Date} paidAt
 */
InlineResponse20051.prototype['paidAt'] = undefined;

/**
 * Савка байера.
 * @member {Number} buyerRate
 */
InlineResponse20051.prototype['buyerRate'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineResponse20051.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineResponse20051.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineResponse20051.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineResponse20051.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineResponse20051.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineResponse20051.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineResponse20051.prototype['strategyStatus'] = undefined;

/**
 * Признак needCheckBySupervisor
 * @member {Boolean} needCheckBySupervisor
 */
InlineResponse20051.prototype['needCheckBySupervisor'] = undefined;

/**
 * Сколько такого продукта находится в заказах.
 * @member {Number} amountInOrders
 */
InlineResponse20051.prototype['amountInOrders'] = undefined;

/**
 * Сколько такого продукта находится в заказах в статусах 0, 2, 3.
 * @member {Number} amountInPendingOrders
 */
InlineResponse20051.prototype['amountInPendingOrders'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusBoxAmounts>} boxAmounts
 */
InlineResponse20051.prototype['boxAmounts'] = undefined;

/**
 * Флаг указывает что продукт в архиве.
 * @member {Boolean} archive
 */
InlineResponse20051.prototype['archive'] = undefined;

/**
 * hsCode продукта.
 * @member {String} hsCode
 */
InlineResponse20051.prototype['hsCode'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineResponse20051.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineResponse20051.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineResponse20051.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineResponse20051.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineResponse20051.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineResponse20051.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineResponse20051.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineResponse20051.prototype['avgReviews'] = undefined;

/**
 * Каков должен быть сток за 4 месяца
 * @member {Number} fourMonthesStock
 */
InlineResponse20051.prototype['fourMonthesStock'] = undefined;

/**
 * @member {Number} stockUSA
 */
InlineResponse20051.prototype['stockUSA'] = undefined;

/**
 * @member {Number} reservedSum
 */
InlineResponse20051.prototype['reservedSum'] = undefined;

/**
 * @member {Number} sentToFbaSum
 */
InlineResponse20051.prototype['sentToFbaSum'] = undefined;

/**
 * @member {Number} fbaFbmStockSum
 */
InlineResponse20051.prototype['fbaFbmStockSum'] = undefined;

/**
 * @member {Number} ideasOnCheck
 */
InlineResponse20051.prototype['ideasOnCheck'] = undefined;

/**
 * @member {Number} ideasVerified
 */
InlineResponse20051.prototype['ideasVerified'] = undefined;

/**
 * @member {Number} ideasClosed
 */
InlineResponse20051.prototype['ideasClosed'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusCreatedBy>} subUsers
 */
InlineResponse20051.prototype['subUsers'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusRedFlags>} redFlags
 */
InlineResponse20051.prototype['redFlags'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusTags>} tags
 */
InlineResponse20051.prototype['tags'] = undefined;
