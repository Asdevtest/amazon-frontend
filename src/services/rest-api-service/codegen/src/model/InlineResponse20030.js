 ...
 */
InlineResponse20030.prototype['destination'] = undefined;

/**
 * @member {String} item
 */
InlineResponse20030.prototype['item'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineResponse20030.prototype['priceInYuan'] = undefined;

/**
 * Сумма частичной оплаты
 * @member {Number} partialPaymentAmountRmb
 */
InlineResponse20030.prototype['partialPaymentAmountRmb'] = undefined;

/**
 * Используется ли частичная оплата
 * @member {Boolean} partialPayment
 */
InlineResponse20030.prototype['partialPayment'] = undefined;

/**
 * Есть ли реквизиты в ордере
 * @member {Boolean} paymentDetailsAttached
 */
InlineResponse20030.prototype['paymentDetailsAttached'] = undefined;

/**
 * Cумма частичной оплаты
 * @member {Number} partiallyPaid
 */
InlineResponse20030.prototype['partiallyPaid'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersOrdersMyPayments>} payments
 */
InlineResponse20030.prototype['payments'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyOrderSupplier} orderSupplier
 */
InlineResponse20030.prototype['orderSupplier'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineResponse20030.PriorityEnum} priority
 */
 ...
 */
InlineResponse20030.prototype['expressChinaDelivery'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineResponse20030.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineResponse20030.prototype['deadline'] = undefined;

/**
 * Дата оплаты поставщтку
 * @member {String} paymentDateToSupplier
 */
InlineResponse20030.prototype['paymentDateToSupplier'] = undefined;

/**
 * Сумма оплаты $ за партию товара - это сумма в $ указывается закупщиком
 * @member {Number} totalPrice
 */
InlineResponse20030.prototype['totalPrice'] = undefined;
 ...
 */
InlineResponse20030.prototype['totalPriceChanged'] = undefined;
 ...
 */
InlineResponse20030.prototype['product'] = undefined;
 ...
 * @readonly
 */
InlineResponse20030['PriorityEnum'] = {
