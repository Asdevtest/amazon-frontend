 ...
 */
InlineObject68.prototype['amount'] = undefined;

/**
 * Гуид сапплаера
 * @member {String} orderSupplierId
 */
InlineObject68.prototype['orderSupplierId'] = undefined;

/**
 * Склад для изменения
 * @member {String} storekeeperId
 */
InlineObject68.prototype['storekeeperId'] = undefined;

/**
 * Пункт назначения
 * @member {String} destinationId
 */
InlineObject68.prototype['destinationId'] = undefined;

/**
 * Тариф для изменения
 * @member {String} logicsTariffId
 */
InlineObject68.prototype['logicsTariffId'] = undefined;
 ...
 */
InlineObject68.prototype['totalPrice'] = undefined;
 ...
 * @member {String} item
 */
InlineObject68.prototype['item'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineObject68.prototype['needsResearch'] = undefined;

/**
 * Дедлайн выкупа заказа
 * @member {Date} deadline
 */
InlineObject68.prototype['deadline'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineObject68.PriorityEnum} priority
 */
InlineObject68.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineObject68.prototype['expressChinaDelivery'] = undefined;
 ...
 */
InlineObject68.prototype['priceInYuan'] = undefined;

/**
 * Цена доставки партии в юанях
 * @member {Number} priceBatchDeliveryInYuan
 */
InlineObject68.prototype['priceBatchDeliveryInYuan'] = undefined;
