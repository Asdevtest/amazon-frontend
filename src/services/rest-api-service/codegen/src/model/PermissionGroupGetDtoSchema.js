 ...
 * @module model/PermissionGroupGetDtoSchema
 * @version 0.1.0
 */
class PermissionGroupGetDtoSchema {
    /**
     * Constructs a new <code>PermissionGroupGetDtoSchema</code>.
     * Группа permission
     * @alias module:model/PermissionGroupGetDtoSchema
    ...
    constructor(key, title, description, permissions, role, createdById, createdAt, updatedAt) { 
        ...
        PermissionGroupGetDtoSchema.initialize(this, key, title, description, permissions, role, createdById, createdAt, updatedAt);
    }
    ...
    /**
     * Constructs a <code>PermissionGroupGetDtoSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PermissionGroupGetDtoSchema} obj Optional instance to populate.
     * @return {module:model/PermissionGroupGetDtoSchema} The populated <code>PermissionGroupGetDtoSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionGroupGetDtoSchema();
 ...
 * @member {String} _id
 */
PermissionGroupGetDtoSchema.prototype['_id'] = undefined;

/**
 * Ключ группы пермишенов
 * @member {String} key
 */
PermissionGroupGetDtoSchema.prototype['key'] = undefined;

/**
 * Простое название
 * @member {String} title
 */
PermissionGroupGetDtoSchema.prototype['title'] = undefined;
 ...
 */
PermissionGroupGetDtoSchema.prototype['createdById'] = undefined;

/**
 * GUID любого, кто последний редактировал группу permission.
 * @member {String} lastModifiedById
 */
PermissionGroupGetDtoSchema.prototype['lastModifiedById'] = undefined;

/**
 * Дата создания
 * @member {Date} createdAt
 */
PermissionGroupGetDtoSchema.prototype['createdAt'] = undefined;

/**
 * Дата изменения
 * @member {Date} updatedAt
 */
PermissionGroupGetDtoSchema.prototype['updatedAt'] = undefined;
...
export default PermissionGroupGetDtoSchema;
