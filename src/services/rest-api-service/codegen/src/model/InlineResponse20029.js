 ...
 */
InlineResponse20029.prototype['owner'] = undefined;

/**
 * GUID покупателя магазина
 * @member {String} bidderId
 */
InlineResponse20029.prototype['bidderId'] = undefined;

/**
 * GUID модератора магазина
 * @member {String} moderatorId
 */
InlineResponse20029.prototype['moderatorId'] = undefined;

/**
 * GUID чата
 * @member {String} chatId
 */
InlineResponse20029.prototype['chatId'] = undefined;
 ...
 */
InlineResponse20029.prototype['files'] = undefined;
 ...
 */
InlineResponse20029.prototype['monthlyProfit'] = undefined;

/**
 * Ежемесячная чистая прибыль
 * @member {Number} monthlyPureProfit
 */
InlineResponse20029.prototype['monthlyPureProfit'] = undefined;

/**
 * Ежемесячный множитель
 * @member {Number} monthlyMultiplier
 */
InlineResponse20029.prototype['monthlyMultiplier'] = undefined;

/**
 * Статистика магазина по месяцам
 * @member {Array.<module:model/ApiV1ShopSellStatistics1>} statistics
 */
InlineResponse20029.prototype['statistics'] = undefined;

/**
 * Дата создания бизнеса
 * @member {Date} businessStartDate
 */
InlineResponse20029.prototype['businessStartDate'] = undefined;

/**
 * Детали магазина
 * @member {String} shopDetails
 */
InlineResponse20029.prototype['shopDetails'] = undefined;

/**
 * Ссылка магазина
 * @member {String} shopLink
 */
InlineResponse20029.prototype['shopLink'] = undefined;

/**
 * Массив активов
 * @member {Array.<String>} shopAssets
 */
InlineResponse20029.prototype['shopAssets'] = undefined;

/**
 * Массив возможностей
 * @member {Array.<String>} opportunities
 */
InlineResponse20029.prototype['opportunities'] = undefined;

/**
 * Массив рисков
 * @member {Array.<String>} risks
 */
InlineResponse20029.prototype['risks'] = undefined;

/**
 * Массив требуемых навыков
 * @member {Array.<String>} requiredSkills
 */
InlineResponse20029.prototype['requiredSkills'] = undefined;

/**
 * Поддержка продавца включает
 * @member {Array.<String>} sellIncludes
 */
InlineResponse20029.prototype['sellIncludes'] = undefined;

/**
 * Причины продажи
 * @member {Array.<String>} reasonForSale
 */
InlineResponse20029.prototype['reasonForSale'] = undefined;

/**
 * Дополнительная информация
 * @member {Array.<String>} additionalInfo
 */
InlineResponse20029.prototype['additionalInfo'] = undefined;
