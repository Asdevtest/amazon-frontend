    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('proposal')) {
                obj['proposal'] = InlineResponse20014.constructFromObject(data['proposal']);
            }
...
/**
 * @member {module:model/InlineResponse20014} proposal
 */
InlineResponse20022.prototype['proposal'] = undefined;

/**
 * @member {module:model/ApiV1RequestProposalsCustomByRequestIdGuidDetails} details
 */
InlineResponse20022.prototype['details'] = undefined;
