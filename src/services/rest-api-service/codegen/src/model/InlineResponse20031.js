...
import InlineResponse20031Details from './InlineResponse20031Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20021.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20031Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20021} request
 */
InlineResponse20031.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20031Details} details
 */
InlineResponse20031.prototype['details'] = undefined;
