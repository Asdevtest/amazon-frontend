...
/**
 * The UserDtoSchema model module.
 * @module model/UserDtoSchema
 * @version v0.0.1
 */
class UserDtoSchema {
    /**
     * Constructs a new <code>UserDtoSchema</code>.
     * @alias module:model/UserDtoSchema
    ...
    constructor(_id, name, email, role, fba, active, rate) { 
        ...
        UserDtoSchema.initialize(this, _id, name, email, role, fba, active, rate);
    }
    ...
    /**
     * Constructs a <code>UserDtoSchema</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserDtoSchema} obj Optional instance to populate.
     * @return {module:model/UserDtoSchema} The populated <code>UserDtoSchema</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserDtoSchema();
 ...
 * @member {String} _id
 */
UserDtoSchema.prototype['_id'] = undefined;

/**
 * Имя пользователя.
 * @member {String} name
 */
UserDtoSchema.prototype['name'] = undefined;

/**
 * email
 * @member {String} email
 */
UserDtoSchema.prototype['email'] = undefined;
 ...
 * @member {Number} role
 */
UserDtoSchema.prototype['role'] = undefined;

/**
 * Флаг fba.
 * @member {Boolean} fba
 */
UserDtoSchema.prototype['fba'] = undefined;

/**
 * Если истина - пользователь активен. Если нет - заблокирован админом.
 * @member {Boolean} active
 */
UserDtoSchema.prototype['active'] = undefined;

/**
 * Ставка, по который оплачивается сотрудник.
 * @member {Number} rate
 */
UserDtoSchema.prototype['rate'] = undefined;
