...
import InlineResponse20023Details from './InlineResponse20023Details';
import InlineResponse20023Request from './InlineResponse20023Request';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20023Request.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20023Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20023Request} request
 */
InlineResponse20023.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20023Details} details
 */
