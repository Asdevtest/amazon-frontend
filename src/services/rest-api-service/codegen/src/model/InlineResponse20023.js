...
import InlineResponse20023Failed from './InlineResponse20023Failed';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('failed')) {
                obj['failed'] = ApiClient.convertToType(data['failed'], [InlineResponse20023Failed]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/InlineResponse20023Failed>} failed
 */
InlineResponse20023.prototype['failed'] = undefined;
