 ...
 */
InlineResponse20023.prototype['buyerComment'] = undefined;
 ...
 * @member {String} item
 */
InlineResponse20023.prototype['item'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineResponse20023.prototype['priceInYuan'] = undefined;

/**
 * Сумма частичной оплаты
 * @member {Number} partialPaymentAmountRmb
 */
InlineResponse20023.prototype['partialPaymentAmountRmb'] = undefined;

/**
 * Используется ли частичная оплата
 * @member {Boolean} partialPayment
 */
InlineResponse20023.prototype['partialPayment'] = undefined;

/**
 * Есть ли реквизиты в ордере
 * @member {Boolean} paymentDetailsAttached
 */
InlineResponse20023.prototype['paymentDetailsAttached'] = undefined;

/**
 * Cумма частичной оплаты
 * @member {Number} partiallyPaid
 */
InlineResponse20023.prototype['partiallyPaid'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersOrdersMyPayments>} payments
 */
InlineResponse20023.prototype['payments'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyOrderSupplier} orderSupplier
 */
InlineResponse20023.prototype['orderSupplier'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineResponse20023.PriorityEnum} priority
 */
InlineResponse20023.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineResponse20023.prototype['expressChinaDelivery'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineResponse20023.prototype['needsResearch'] = undefined;
 ...
 */
InlineResponse20023.prototype['paymentDateToSupplier'] = undefined;

/**
 * Сумма оплаты $ за партию товара - это сумма в $ указывается закупщиком
 * @member {Number} totalPrice
 */
InlineResponse20023.prototype['totalPrice'] = undefined;
 ...
 */
InlineResponse20023.prototype['totalPriceChanged'] = undefined;
 ...
 */
InlineResponse20023.prototype['product'] = undefined;
 ...
 * @readonly
 */
InlineResponse20023['PriorityEnum'] = {
