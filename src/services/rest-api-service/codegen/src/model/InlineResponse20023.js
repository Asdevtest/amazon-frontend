 ...
 */
InlineResponse20023.prototype['humanFriendlyId'] = undefined;

/**
 * ККоличества в коробке.
 * @member {Number} amount
 */
InlineResponse20023.prototype['amount'] = undefined;
 ...
 */
InlineResponse20023.prototype['isActual'] = undefined;

/**
 * Если true - значит коробку черновик.
 * @member {Boolean} isDraft
 */
InlineResponse20023.prototype['isDraft'] = undefined;

/**
 * Сформирована ли коробка
 * @member {Boolean} isFormed
 */
InlineResponse20023.prototype['isFormed'] = undefined;

/**
 * Ссылка на наклейку для коробки
 * @member {String} shippingLabel
 */
InlineResponse20023.prototype['shippingLabel'] = undefined;

/**
 * Текст трек номера
 * @member {String} trackNumberText
 */
InlineResponse20023.prototype['trackNumberText'] = undefined;

/**
 * @member {Array.<String>} trackNumberFile
 */
InlineResponse20023.prototype['trackNumberFile'] = undefined;

/**
 * Значение информационного ключа
 * @member {String} prepId
 */
InlineResponse20023.prototype['prepId'] = undefined;

/**
 * Идентификатор UPS
 * @member {String} upsTrackNumber
 */
InlineResponse20023.prototype['upsTrackNumber'] = undefined;

/**
 * Дополнительное поле shippingLabel для доставки грузовиками
 * @member {String} referenceId
 */
InlineResponse20023.prototype['referenceId'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} clientComment
 */
InlineResponse20023.prototype['clientComment'] = undefined;

/**
 * Комментарии к коробке
 * @member {String} storekeeperComment
 */
InlineResponse20023.prototype['storekeeperComment'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} lengthCmWarehouse
 */
InlineResponse20023.prototype['lengthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} widthCmWarehouse
 */
InlineResponse20023.prototype['widthCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} heightCmWarehouse
 */
InlineResponse20023.prototype['heightCmWarehouse'] = undefined;

/**
 * Что фактически пришло на склад. Кладовщик.
 * @member {Number} weighGrossKgWarehouse
 */
InlineResponse20023.prototype['weighGrossKgWarehouse'] = undefined;
 ...
 */
InlineResponse20023.prototype['isShippingLabelAttachedByStorekeeper'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaShipment
 */
InlineResponse20023.prototype['fbaShipment'] = undefined;

/**
 * Это номер конкретной коробки при отправке в амазон.
 * @member {String} fbaNumber
 */
InlineResponse20023.prototype['fbaNumber'] = undefined;

/**
 * Итого за доставку.
 * @member {Number} deliveryTotalPrice
 */
InlineResponse20023.prototype['deliveryTotalPrice'] = undefined;

/**
 * Обновление итога за доставку.
 * @member {Number} deliveryTotalPriceChanged
 */
InlineResponse20023.prototype['deliveryTotalPriceChanged'] = undefined;
 ...
 */
InlineResponse20023.prototype['deadline'] = undefined;
 ...
 */
InlineResponse20023.prototype['variationTariff'] = undefined;
