 ...
 */
InlineResponse20013.prototype['buyerComment'] = undefined;
 ...
 * @member {String} item
 */
InlineResponse20013.prototype['item'] = undefined;

/**
 * Цена в юанях
 * @member {Number} priceInYuan
 */
InlineResponse20013.prototype['priceInYuan'] = undefined;

/**
 * Сумма частичной оплаты
 * @member {Number} partialPaymentAmountRmb
 */
InlineResponse20013.prototype['partialPaymentAmountRmb'] = undefined;

/**
 * Используется ли частичная оплата
 * @member {Boolean} partialPayment
 */
InlineResponse20013.prototype['partialPayment'] = undefined;

/**
 * Есть ли реквизиты в ордере
 * @member {Boolean} paymentDetailsAttached
 */
InlineResponse20013.prototype['paymentDetailsAttached'] = undefined;

/**
 * Cумма частичной оплаты
 * @member {Number} partiallyPaid
 */
InlineResponse20013.prototype['partiallyPaid'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersOrdersMyPayments>} payments
 */
InlineResponse20013.prototype['payments'] = undefined;

/**
 * @member {module:model/ApiV1BuyersOrdersMyOrderSupplier} orderSupplier
 */
InlineResponse20013.prototype['orderSupplier'] = undefined;

/**
 * Приоритет заказа: от 10 до 50 - от найменее значимого до найболее значимого соответственно
 * @member {module:model/InlineResponse20013.PriorityEnum} priority
 */
InlineResponse20013.prototype['priority'] = undefined;

/**
 * Флаг , обозначающий оплату за экспресс доставку по китаю
 * @member {Boolean} expressChinaDelivery
 */
InlineResponse20013.prototype['expressChinaDelivery'] = undefined;

/**
 * Нуждается ли заказ в повторном поиске поставщика
 * @member {Boolean} needsResearch
 */
InlineResponse20013.prototype['needsResearch'] = undefined;
 ...
 */
InlineResponse20013.prototype['paymentDateToSupplier'] = undefined;

/**
 * Сумма оплаты $ за партию товара - это сумма в $ указывается закупщиком
 * @member {Number} totalPrice
 */
InlineResponse20013.prototype['totalPrice'] = undefined;
 ...
 */
InlineResponse20013.prototype['totalPriceChanged'] = undefined;
 ...
 */
InlineResponse20013.prototype['product'] = undefined;
 ...
 * @readonly
 */
InlineResponse20013['PriorityEnum'] = {
