 ...
 * @member {String} asin
 */
InlineObject89.prototype['asin'] = undefined;

/**
 * @member {Array.<String>} skusByClient
 */
InlineObject89.prototype['skusByClient'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject89.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject89.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject89.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject89.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject89.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject89.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject89.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject89.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject89.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject89.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject89.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject89.prototype['fbaamount'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject89.prototype['icomment'] = undefined;

/**
 * Комментарии к товару, от клиента.
 * @member {String} clientComment
 */
InlineObject89.prototype['clientComment'] = undefined;
 ...
 */
InlineObject89.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject89.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject89.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineObject89.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineObject89.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineObject89.prototype['chinaTitle'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject89.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject89.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject89.prototype['margin'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject89.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject89.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject89.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject89.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject89.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject89.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject89.prototype['strategyStatus'] = undefined;

/**
 * Признак needCheckBySupervisor
 * @member {Boolean} needCheckBySupervisor
 */
InlineObject89.prototype['needCheckBySupervisor'] = undefined;

/**
 * Флаг указывает что продукт в архиве.
 * @member {Boolean} archive
 */
InlineObject89.prototype['archive'] = undefined;

/**
 * hsCode продукта.
 * @member {String} hsCode
 */
InlineObject89.prototype['hsCode'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject89.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject89.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject89.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject89.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject89.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject89.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject89.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject89.prototype['avgReviews'] = undefined;

/**
 * Поле для калькуляции дозакупок
 * @member {Number} fourMonthesStock
 */
InlineObject89.prototype['fourMonthesStock'] = undefined;

/**
 * ID магазинов для продукта
 * @member {Array.<String>} shopIds
 */
InlineObject89.prototype['shopIds'] = undefined;

/**
 * @member {Array.<module:model/ApiV1ResearchersProductsGuidRedFlags>} redFlags
 */
InlineObject89.prototype['redFlags'] = undefined;

/**
 * @member {Array.<module:model/ApiV1BuyersProductsGuidTags>} tags
 */
InlineObject89.prototype['tags'] = undefined;
