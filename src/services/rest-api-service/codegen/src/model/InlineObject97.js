 ...
 */
InlineObject97.prototype['description'] = undefined;

/**
 * Время доставки, днях
 * @member {String} deliveryTimeInDay
 */
InlineObject97.prototype['deliveryTimeInDay'] = undefined;

/**
 * Дата закрытия приема новых грузов.
 * @member {Date} cls
 */
InlineObject97.prototype['cls'] = undefined;

/**
 * Ожидаема дата отбытия.
 * @member {Date} etd
 */
InlineObject97.prototype['etd'] = undefined;

/**
 * Ожидаема дата прибытия.
 * @member {Date} eta
 */
InlineObject97.prototype['eta'] = undefined;

/**
 * Минимальный вес, в кг
 * @member {Number} minWeightInKg
 */
InlineObject97.prototype['minWeightInKg'] = undefined;

/**
 * Заархивирован ли тариф
 * @member {Boolean} archive
 */
InlineObject97.prototype['archive'] = undefined;

/**
 * @member {module:model/ApiV1AdminsOrdersLogicsTariffConditionsByRegion} conditionsByRegion
 */
InlineObject97.prototype['conditionsByRegion'] = undefined;
