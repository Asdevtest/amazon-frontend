...
import InlineResponse20061Details from './InlineResponse20061Details';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request')) {
                obj['request'] = InlineResponse20049.constructFromObject(data['request']);
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = InlineResponse20061Details.constructFromObject(data['details']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/InlineResponse20049} request
 */
InlineResponse20061.prototype['request'] = undefined;

/**
 * @member {module:model/InlineResponse20061Details} details
 */
InlineResponse20061.prototype['details'] = undefined;
