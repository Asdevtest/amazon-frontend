  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('clientId')) {
        obj['clientId'] = ApiV1AdminsGetProductsByStatusCreatedby.constructFromObject(data['clientId'])
      }
      ...
      if (data.hasOwnProperty('listingBulletPoints')) {
        obj['listingBulletPoints'] = ApiClient.convertToType(data['listingBulletPoints'], 'Array')
      }
      ...
      if (data.hasOwnProperty('listingSubjectMatters')) {
        obj['listingSubjectMatters'] = ApiClient.convertToType(data['listingSubjectMatters'], 'Array')
      }
      if (data.hasOwnProperty('listingImages')) {
        obj['listingImages'] = ApiClient.convertToType(data['listingImages'], 'Array')
      }
