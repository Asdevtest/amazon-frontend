 ...
 */
InlineObject75.prototype['material'] = undefined;

/**
 * Признак fbm
 * @member {Boolean} fbm
 */
InlineObject75.prototype['fbm'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineObject75.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject75.prototype['lamazon'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lsupplier
 */
InlineObject75.prototype['lsupplier'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject75.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject75.prototype['fba'] = undefined;

/**
 *  уточнить 
 * @member {Boolean} express
 */
InlineObject75.prototype['express'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject75.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject75.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject75.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject75.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject75.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject75.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject75.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject75.prototype['fbaamount'] = undefined;

/**
 * @member {String} fbalink
 */
InlineObject75.prototype['fbalink'] = undefined;

/**
 * Стоимость доставки.
 * @member {Number} delivery
 */
InlineObject75.prototype['delivery'] = undefined;

/**
 * См. описание статусов например в readMe.md
 * @member {Number} status
 */
InlineObject75.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject75.prototype['icomment'] = undefined;
 ...
 */
InlineObject75.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject75.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject75.prototype['amazonTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject75.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject75.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject75.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject75.prototype['margin'] = undefined;

/**
 * Цена
 * @member {Number} byboxprice
 */
InlineObject75.prototype['byboxprice'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject75.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject75.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject75.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject75.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject75.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject75.prototype['listingImages'] = undefined;

/**
 * 
 * @member {String} listingTaskToFindSupplier
 */
InlineObject75.prototype['listingTaskToFindSupplier'] = undefined;

/**
 * 
 * @member {String} listingSupplierImportantPoints
 */
InlineObject75.prototype['listingSupplierImportantPoints'] = undefined;

/**
 * 
 * @member {String} listingExtraInfo
 */
InlineObject75.prototype['listingExtraInfo'] = undefined;
 ...
 */
InlineObject75.prototype['listingSupplierCompetitors'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject75.prototype['strategyStatus'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject75.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject75.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject75.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject75.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject75.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject75.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject75.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject75.prototype['avgReviews'] = undefined;

/**
 * Комментарий к статусу проверки.
 * @member {String} checkednotes
 */
InlineObject75.prototype['checkednotes'] = undefined;
