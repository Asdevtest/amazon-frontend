 ...
 * @member {String} _id
 */
InlineResponse20027Rows.prototype['_id'] = undefined;

/**
 * ASIN продукта
 * @member {String} asin
 */
InlineResponse20027Rows.prototype['asin'] = undefined;

/**
 * @member {Array.<String>} skusByClient
 */
InlineResponse20027Rows.prototype['skusByClient'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusSuppliers>} suppliers
 */
InlineResponse20027Rows.prototype['suppliers'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusSuppliers} currentSupplier
 */
InlineResponse20027Rows.prototype['currentSupplier'] = undefined;

/**
 * GUID поставщика в базе данных
 * @member {String} currentSupplierId
 */
InlineResponse20027Rows.prototype['currentSupplierId'] = undefined;

/**
 * Категория
 * @member {String} category
 */
InlineResponse20027Rows.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineResponse20027Rows.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineResponse20027Rows.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineResponse20027Rows.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineResponse20027Rows.prototype['amazon'] = undefined;

/**
 * Высота
 * @member {Number} height
 */
InlineResponse20027Rows.prototype['height'] = undefined;

/**
 * Ширина
 * @member {Number} width
 */
InlineResponse20027Rows.prototype['width'] = undefined;

/**
 * Длинна
 * @member {Number} length
 */
InlineResponse20027Rows.prototype['length'] = undefined;

/**
 * Вес
 * @member {Number} weight
 */
InlineResponse20027Rows.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineResponse20027Rows.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineResponse20027Rows.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineResponse20027Rows.prototype['fbaamount'] = undefined;

/**
 * Код текущего статуса
 * @member {Number} status
 */
InlineResponse20027Rows.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineResponse20027Rows.prototype['icomment'] = undefined;

/**
 * Комментарии к товару, от клиента.
 * @member {String} clientComment
 */
InlineResponse20027Rows.prototype['clientComment'] = undefined;

/**
 * Массив картинок.
 * @member {Array.<String>} images
 */
InlineResponse20027Rows.prototype['images'] = undefined;

/**
 * @member {Number} priceForClient
 */
InlineResponse20027Rows.prototype['priceForClient'] = undefined;

/**
 * 
 * @member {String} checkednotes
 */
InlineResponse20027Rows.prototype['checkednotes'] = undefined;

/**
 * Признак isCreatedByClient
 * @member {Boolean} isCreatedByClient
 */
InlineResponse20027Rows.prototype['isCreatedByClient'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} client
 */
InlineResponse20027Rows.prototype['client'] = undefined;

/**
 * Описание с сайта амазон.
 * @member {String} amazonDescription
 */
InlineResponse20027Rows.prototype['amazonDescription'] = undefined;

/**
 * Данные из поля детали с сайта амазон.
 * @member {String} amazonDetail
 */
InlineResponse20027Rows.prototype['amazonDetail'] = undefined;

/**
 * Заголовок на товар с сайта амазон.
 * @member {String} amazonTitle
 */
InlineResponse20027Rows.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineResponse20027Rows.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineResponse20027Rows.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineResponse20027Rows.prototype['chinaTitle'] = undefined;

/**
 * Баркод
 * @member {String} barCode
 */
InlineResponse20027Rows.prototype['barCode'] = undefined;

/**
 * Минимальный заказ
 * @member {Number} minpurchase
 */
InlineResponse20027Rows.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineResponse20027Rows.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineResponse20027Rows.prototype['margin'] = undefined;

/**
 * Кол-во товаров, которые находятся в пути
 * @member {Number} inTransfer
 */
InlineResponse20027Rows.prototype['inTransfer'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} createdBy
 */
InlineResponse20027Rows.prototype['createdBy'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} checkedBy
 */
InlineResponse20027Rows.prototype['checkedBy'] = undefined;

/**
 * Дата создания
 * @member {Date} createdAt
 */
InlineResponse20027Rows.prototype['createdAt'] = undefined;

/**
 * Дата изменения
 * @member {Date} updatedAt
 */
InlineResponse20027Rows.prototype['updatedAt'] = undefined;

/**
 * Дата проверки
 * @member {Date} checkedAt
 */
InlineResponse20027Rows.prototype['checkedAt'] = undefined;

/**
 * @member {module:model/ApiV1AdminsGetProductsByStatusCreatedBy} buyer
 */
InlineResponse20027Rows.prototype['buyer'] = undefined;

/**
 * Дедлаин на на поиск поставщика байером.
 * @member {Date} buyerTimeoutAt
 */
InlineResponse20027Rows.prototype['buyerTimeoutAt'] = undefined;

/**
 * Комментарии к товару от байера.
 * @member {String} buyersComment
 */
InlineResponse20027Rows.prototype['buyersComment'] = undefined;

/**
 * ID магазинов для продукта
 * @member {Array.<String>} shopIds
 */
InlineResponse20027Rows.prototype['shopIds'] = undefined;

/**
 * Савка ресечера.
 * @member {Number} researcherRate
 */
InlineResponse20027Rows.prototype['researcherRate'] = undefined;

/**
 * Савка супервайзера.
 * @member {Number} supervisorRate
 */
InlineResponse20027Rows.prototype['supervisorRate'] = undefined;

/**
 * Дата оплаты
 * @member {Date} paidAt
 */
InlineResponse20027Rows.prototype['paidAt'] = undefined;

/**
 * Савка байера.
 * @member {Number} buyerRate
 */
InlineResponse20027Rows.prototype['buyerRate'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineResponse20027Rows.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineResponse20027Rows.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineResponse20027Rows.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineResponse20027Rows.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineResponse20027Rows.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineResponse20027Rows.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineResponse20027Rows.prototype['strategyStatus'] = undefined;

/**
 * Кол-во идей продукта в статусе 10
 * @member {Number} ideasCounter
 */
InlineResponse20027Rows.prototype['ideasCounter'] = undefined;

/**
 * Признак needCheckBySupervisor
 * @member {Boolean} needCheckBySupervisor
 */
InlineResponse20027Rows.prototype['needCheckBySupervisor'] = undefined;

/**
 * Сколько такого продукта находится в заказах.
 * @member {Number} amountInOrders
 */
InlineResponse20027Rows.prototype['amountInOrders'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusBoxAmounts>} boxAmounts
 */
InlineResponse20027Rows.prototype['boxAmounts'] = undefined;

/**
 * Флаг указывает что продукт в архиве.
 * @member {Boolean} archive
 */
InlineResponse20027Rows.prototype['archive'] = undefined;

/**
 * hsCode продукта.
 * @member {String} hsCode
 */
InlineResponse20027Rows.prototype['hsCode'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineResponse20027Rows.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineResponse20027Rows.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineResponse20027Rows.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineResponse20027Rows.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineResponse20027Rows.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineResponse20027Rows.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineResponse20027Rows.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineResponse20027Rows.prototype['avgReviews'] = undefined;

/**
 * Каков должен быть сток за 4 месяца
 * @member {Number} fourMonthesStock
 */
InlineResponse20027Rows.prototype['fourMonthesStock'] = undefined;

/**
 * @member {Number} stockUSA
 */
InlineResponse20027Rows.prototype['stockUSA'] = undefined;

/**
 * @member {Array.<module:model/ApiV1AdminsGetProductsByStatusCreatedBy>} subUsers
 */
InlineResponse20027Rows.prototype['subUsers'] = undefined;
