 ...
 */
InlineObject87.prototype['category'] = undefined;

/**
 * Ссылка на этот продукт на амазоне.
 * @member {String} lamazon
 */
InlineObject87.prototype['lamazon'] = undefined;

/**
 * 
 * @member {Number} bsr
 */
InlineObject87.prototype['bsr'] = undefined;

/**
 * Признак fba
 * @member {Boolean} fba
 */
InlineObject87.prototype['fba'] = undefined;

/**
 * 
 * @member {Number} amazon
 */
InlineObject87.prototype['amazon'] = undefined;

/**
 * @member {Number} height
 */
InlineObject87.prototype['height'] = undefined;

/**
 * @member {Number} width
 */
InlineObject87.prototype['width'] = undefined;

/**
 * @member {Number} length
 */
InlineObject87.prototype['length'] = undefined;

/**
 * @member {Number} weight
 */
InlineObject87.prototype['weight'] = undefined;

/**
 * комиссия которую берет амазон за любой заказ - 15%
 * @member {Number} reffee
 */
InlineObject87.prototype['reffee'] = undefined;

/**
 * ФБА комиссия
 * @member {Number} fbafee
 */
InlineObject87.prototype['fbafee'] = undefined;

/**
 *  Общая сумма с фба.
 * @member {Number} fbaamount
 */
InlineObject87.prototype['fbaamount'] = undefined;

/**
 *  Статус товара. У ресечера: 0 - новый товар. 5- готов к проверке супером. 10 - новый товар с поставщиком
 * @member {Number} status
 */
InlineObject87.prototype['status'] = undefined;

/**
 * Комментарии к товару.
 * @member {String} icomment
 */
InlineObject87.prototype['icomment'] = undefined;

/**
 * Массив изображений.
 * @member {Array.<String>} images
 */
InlineObject87.prototype['images'] = undefined;

/**
 * @member {String} amazonDescription
 */
InlineObject87.prototype['amazonDescription'] = undefined;

/**
 * @member {String} amazonDetail
 */
InlineObject87.prototype['amazonDetail'] = undefined;

/**
 * @member {String} amazonTitle
 */
InlineObject87.prototype['amazonTitle'] = undefined;

/**
 * Материл продукта
 * @member {String} material
 */
InlineObject87.prototype['material'] = undefined;

/**
 * Применение продукта
 * @member {String} productUsage
 */
InlineObject87.prototype['productUsage'] = undefined;

/**
 * chinese title?
 * @member {String} chinaTitle
 */
InlineObject87.prototype['chinaTitle'] = undefined;

/**
 * @member {String} barCode
 */
InlineObject87.prototype['barCode'] = undefined;

/**
 * @member {Number} minpurchase
 */
InlineObject87.prototype['minpurchase'] = undefined;

/**
 * Прибыль
 * @member {Number} profit
 */
InlineObject87.prototype['profit'] = undefined;

/**
 * Маржа
 * @member {Number} margin
 */
InlineObject87.prototype['margin'] = undefined;

/**
 * 
 * @member {String} listingName
 */
InlineObject87.prototype['listingName'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingBulletPoints
 */
InlineObject87.prototype['listingBulletPoints'] = undefined;

/**
 * 
 * @member {String} listingProductDetails
 */
InlineObject87.prototype['listingProductDetails'] = undefined;

/**
 * 
 * @member {String} listingSearchTerms
 */
InlineObject87.prototype['listingSearchTerms'] = undefined;

/**
 * Массив ...
 * @member {Array.<String>} listingSubjectMatters
 */
InlineObject87.prototype['listingSubjectMatters'] = undefined;

/**
 * массив картинок(в виде прямых ссылок).
 * @member {Array.<String>} listingImages
 */
InlineObject87.prototype['listingImages'] = undefined;

/**
 * У поля на данный момент будет 5 возможных значений: 0, 10, 20, 30, 40
 * @member {Number} strategyStatus
 */
InlineObject87.prototype['strategyStatus'] = undefined;

/**
 * Ниша
 * @member {String} niche
 */
InlineObject87.prototype['niche'] = undefined;

/**
 * Асины
 * @member {String} asins
 */
InlineObject87.prototype['asins'] = undefined;

/**
 * Общий доход
 * @member {String} totalRevenue
 */
InlineObject87.prototype['totalRevenue'] = undefined;

/**
 * Коэффициент прибыли
 * @member {String} coefficient
 */
InlineObject87.prototype['coefficient'] = undefined;

/**
 * Средний доход
 * @member {String} avgRevenue
 */
InlineObject87.prototype['avgRevenue'] = undefined;

/**
 * Средний BSR
 * @member {String} avgBSR
 */
InlineObject87.prototype['avgBSR'] = undefined;

/**
 * Средняя цена
 * @member {String} avgPrice
 */
InlineObject87.prototype['avgPrice'] = undefined;

/**
 * Средний отзывы
 * @member {String} avgReviews
 */
InlineObject87.prototype['avgReviews'] = undefined;
