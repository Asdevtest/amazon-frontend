...
export const PermissionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PermissionsProductsPatch: async (body?: InlineObject90, acceptEncoding?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/permissions/products`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        apiV1PermissionsShopsPatch: async (body?: InlineObject91, acceptEncoding?: string, options: any = {}): Promise<RequestArgs> => {
...
export const PermissionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1PermissionsProductsPatch(body?: InlineObject90, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async apiV1PermissionsShopsPatch(body?: InlineObject91, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export const PermissionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1PermissionsProductsPatch(body?: InlineObject90, acceptEncoding?: string, options?: any): AxiosPromise<string> {
         ...
         * @throws {RequiredError}
         */
        apiV1PermissionsShopsPatch(body?: InlineObject91, acceptEncoding?: string, options?: any): AxiosPromise<string> {
