...
export const ResearcherApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ResearchersProductsGuidPatch: async (guid: string, body?: InlineObject117, acceptEncoding?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'guid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        apiV1ResearchersProductsPost: async (body?: InlineObject116, acceptEncoding?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/researchers/products`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ResearcherApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResearchersCheckProductsAsinStrategyGet(asin: string, strategy: string, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20092>> {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResearchersProductsGuidPatch(guid: string, body?: InlineObject117, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async apiV1ResearchersProductsPost(body?: InlineObject116, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2017>> {
...
export const ResearcherApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1ResearchersCheckProductsAsinStrategyGet(asin: string, strategy: string, acceptEncoding?: string, options?: any): AxiosPromise<InlineResponse20092> {
         ...
         * @throws {RequiredError}
         */
        apiV1ResearchersProductsGuidPatch(guid: string, body?: InlineObject117, acceptEncoding?: string, options?: any): AxiosPromise<string> {
         ...
         * @throws {RequiredError}
         */
        apiV1ResearchersProductsPost(body?: InlineObject116, acceptEncoding?: string, options?: any): AxiosPromise<InlineResponse2017> {
