...
export const GeneralApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'boxes' | 'announcements' | 'orders' | 'products' | 'batches' | 'tasks' | 'requests' | 'proposals' | 'suppliers' | 'ideas' | 'inventoryReturns' | 'inventory' | 'inventoryShipments' | 'ppcSalesWeeks' | 'ppcSalesDays' | 'sellerboardWarehouseEveryDay' | 'sellerboardLast30Days' | 'payments' | 'storekeepers' | 'user_notifications' | 'productListingReports' | 'users' | 'ACCOUNT_HEALTH' | 'BRANDS_REVIEW' | 'BUSINESS_REPORTS' | 'CAMPAIGNS' | 'FYP_OUT_OF_STOCK' | 'FYP_SEARCH_SUPPRESSED' | 'INCOME' | 'INVENTORY' | 'INVENTORY_PLANNING' | 'INVENTORY_SHIPMENTS' | 'ORDERS' | 'PERFOMANCE_NOTIFICATIONS' | 'PPC_ORGANIC' | 'PPC_SALES_WEEKS' | 'RETURNS' | 'TOTAL_BALANCE' | 'TRANSACTIONS' | 'VOICE' | 'PROFILE' | 'RECEIVING_REQUESTS'} table Таблица
...
export const GeneralApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1GeneralDataFiltersGet(table: 'boxes' | 'announcements' | 'orders' | 'products' | 'batches' | 'tasks' | 'requests' | 'proposals' | 'suppliers' | 'ideas' | 'inventoryReturns' | 'inventory' | 'inventoryShipments' | 'ppcSalesWeeks' | 'ppcSalesDays' | 'sellerboardWarehouseEveryDay' | 'sellerboardLast30Days' | 'payments' | 'storekeepers' | 'user_notifications' | 'productListingReports' | 'users' | 'ACCOUNT_HEALTH' | 'BRANDS_REVIEW' | 'BUSINESS_REPORTS' | 'CAMPAIGNS' | 'FYP_OUT_OF_STOCK' | 'FYP_SEARCH_SUPPRESSED' | 'INCOME' | 'INVENTORY' | 'INVENTORY_PLANNING' | 'INVENTORY_SHIPMENTS' | 'ORDERS' | 'PERFOMANCE_NOTIFICATIONS' | 'PPC_ORGANIC' | 'PPC_SALES_WEEKS' | 'RETURNS' | 'TOTAL_BALANCE' | 'TRANSACTIONS' | 'VOICE' | 'PROFILE' | 'RECEIVING_REQUESTS', column: string, endpoint: string, noCache?: boolean, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>> {
