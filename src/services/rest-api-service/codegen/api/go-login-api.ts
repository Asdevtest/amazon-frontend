...
export const GoLoginApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1GologinProfilePost(body?: InlineObject71, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20059>> {
         ...
         * @throws {RequiredError}
         */
        async apiV1GologinProfileStartPost(body?: InlineObject73, acceptEncoding?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2018>> {
...
export const GoLoginApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1GologinProfilePost(body?: InlineObject71, acceptEncoding?: string, options?: any): AxiosPromise<InlineResponse20059> {
         ...
         * @throws {RequiredError}
         */
        apiV1GologinProfileStartPost(body?: InlineObject73, acceptEncoding?: string, options?: any): AxiosPromise<InlineResponse2018> {
