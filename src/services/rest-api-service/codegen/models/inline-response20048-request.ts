 ...
 * 
 * @export
 * @interface InlineResponse20048Request
 */
export interface InlineResponse20048Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20048Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20048Request
     */
    status?: InlineResponse20048RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20048RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
