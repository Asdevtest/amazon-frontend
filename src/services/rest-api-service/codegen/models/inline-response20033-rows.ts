...
import { InlineResponse20033Destination } from './inline-response20033-destination';
import { InlineResponse20033OrderSupplier } from './inline-response20033-order-supplier';
import { InlineResponse20033Product } from './inline-response20033-product';

/**
 * Заказ.
 * @export
 * @interface InlineResponse20033Rows
 */
export interface InlineResponse20033Rows {
    /**
     * id заказ.
     * @type {number}
     * @memberof InlineResponse20033Rows
     */
    id?: number;
    /**
     ...
     * @memberof InlineResponse20033Rows
     */
    priority?: InlineResponse20033RowsPriorityEnum;
    /**
    ...
    /**
     * 
     * @type {InlineResponse20033Destination}
     * @memberof InlineResponse20033Rows
     */
    destination?: InlineResponse20033Destination;
    /**
     * GUID продукта
     * @type {string}
     * @memberof InlineResponse20033Rows
    ...
    /**
     * 
     * @type {InlineResponse20033Product}
     * @memberof InlineResponse20033Rows
     */
    product?: InlineResponse20033Product;
    /**
     * 
    ...
    /**
     * 
     * @type {InlineResponse20033OrderSupplier}
     * @memberof InlineResponse20033Rows
     */
    orderSupplier?: InlineResponse20033OrderSupplier;
}
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20033RowsPriorityEnum {
    _10 = '10',
    _20 = '20',
    _30 = '30',
    _40 = '40',
