 ...
 * 
 * @export
 * @interface InlineResponse20054Request
 */
export interface InlineResponse20054Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20054Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20054Request
     */
    status?: InlineResponse20054RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20054RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
