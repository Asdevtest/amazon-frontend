...
import { InlineResponse20083Announcement } from './inline-response20083-announcement';
import { InlineResponse20083CountProposalsByStatuses } from './inline-response20083-count-proposals-by-statuses';
import { InlineResponse20083Media } from './inline-response20083-media';
import { InlineResponse20083Product } from './inline-response20083-product';
import { InlineResponse20083Proposals } from './inline-response20083-proposals';

/**
 * Схема заявки.
 * @export
 * @interface InlineResponse20083Rows
 */
export interface InlineResponse20083Rows {
    /**
     * GUID заявки в базе данных.
     * @type {string}
     * @memberof InlineResponse20083Rows
     */
    _id: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20083Rows
     */
    status: InlineResponse20083RowsStatusEnum;
    /**
     ...
     * @memberof InlineResponse20083Rows
     */
    direction: InlineResponse20083RowsDirectionEnum;
    /**
     * Массив массив ролей.
     * @type {Array<number>}
     * @memberof InlineResponse20083Rows
    ...
    /**
     * 
     * @type {Array<InlineResponse20083Media>}
     * @memberof InlineResponse20083Rows
     */
    media?: Array<InlineResponse20083Media>;
    /**
     * 
     * @type {InlineResponse20083Announcement}
     * @memberof InlineResponse20083Rows
     */
    announcement?: InlineResponse20083Announcement;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<InlineResponse20083Proposals>}
     * @memberof InlineResponse20083Rows
     */
    proposals?: Array<InlineResponse20083Proposals>;
    /**
     * 
     * @type {ApiV1AdminsGetProductsByStatusCreatedBy}
     * @memberof InlineResponse20083Rows
    ...
    /**
     * 
     * @type {InlineResponse20083CountProposalsByStatuses}
     * @memberof InlineResponse20083Rows
     */
    countProposalsByStatuses?: InlineResponse20083CountProposalsByStatuses;
    /**
     * 
     * @type {InlineResponse20083Product}
     * @memberof InlineResponse20083Rows
     */
    product?: InlineResponse20083Product;
}
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20083RowsStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20083RowsDirectionEnum {
    In = 'IN',
    Out = 'OUT'
}
