 ...
 * 
 * @export
 * @interface InlineResponse20047Request
 */
export interface InlineResponse20047Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20047Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20047Request
     */
    status?: InlineResponse20047RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20047RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
