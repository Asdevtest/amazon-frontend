 ...
 * 
 * @export
 * @interface InlineResponse20049Request
 */
export interface InlineResponse20049Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20049Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20049Request
     */
    status?: InlineResponse20049RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20049RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
