 ...
 * 
 * @export
 * @interface InlineResponse20055Request
 */
export interface InlineResponse20055Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20055Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20055Request
     */
    status?: InlineResponse20055RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20055RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
