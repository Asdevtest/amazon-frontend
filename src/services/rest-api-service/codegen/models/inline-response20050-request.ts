 ...
 * 
 * @export
 * @interface InlineResponse20050Request
 */
export interface InlineResponse20050Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20050Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20050Request
     */
    status?: InlineResponse20050RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20050RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
