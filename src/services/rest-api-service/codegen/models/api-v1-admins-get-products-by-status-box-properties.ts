 ...
 * Параметры коробок.
 * @export
 * @interface ApiV1AdminsGetProductsByStatusBoxProperties
 */
export interface ApiV1AdminsGetProductsByStatusBoxProperties {
    /**
     * Количество единиц в коробке.
     * @type {number}
     * @memberof ApiV1AdminsGetProductsByStatusBoxProperties
     */
    amountInBox?: number;
    /**
