 ...
 * 
 * @export
 * @interface InlineResponse20046Request
 */
export interface InlineResponse20046Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20046Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20046Request
     */
    status?: InlineResponse20046RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20046RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
