 ...
 * 
 * @export
 * @interface InlineResponse20032Request
 */
export interface InlineResponse20032Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20032Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20032Request
     */
    status?: InlineResponse20032RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20032RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
