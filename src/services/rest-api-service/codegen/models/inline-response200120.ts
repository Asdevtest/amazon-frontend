...
export interface InlineResponse200120 {
     ...
     * @memberof InlineResponse200120
     */
    status?: InlineResponse200120StatusEnum;
    /**
     ...
     * @memberof InlineResponse200120
     */
    direction?: InlineResponse200120DirectionEnum;
    /**
     * Массив массив ролей.
     * @type {Array<number>}
     * @memberof InlineResponse200120
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse200120StatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse200120DirectionEnum {
    In = 'IN',
    Out = 'OUT'
}
