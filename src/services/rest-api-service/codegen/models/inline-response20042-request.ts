 ...
 * 
 * @export
 * @interface InlineResponse20042Request
 */
export interface InlineResponse20042Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse20042Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse20042Request
     */
    status?: InlineResponse20042RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse20042RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
