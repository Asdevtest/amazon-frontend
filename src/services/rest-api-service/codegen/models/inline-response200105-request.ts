 ...
 * 
 * @export
 * @interface InlineResponse200105Request
 */
export interface InlineResponse200105Request {
    /**
     * Гуид продукта
     * @type {string}
     * @memberof InlineResponse200105Request
     */
    _id?: string;
    /**
     * Ключ заявки числом
     ...
     * @memberof InlineResponse200105Request
     */
    status?: InlineResponse200105RequestStatusEnum;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum InlineResponse200105RequestStatusEnum {
    Draft = 'DRAFT',
    Published = 'PUBLISHED',
