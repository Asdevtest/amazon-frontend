...
*TestSwagger.IdeaApi* | [**apiV1IdeasRemoveSuppliersGuidPost**](docs/IdeaApi.md#apiV1IdeasRemoveSuppliersGuidPost) | **POST** /api/v1/ideas/remove_suppliers/{guid} | Удалить поставщиков
