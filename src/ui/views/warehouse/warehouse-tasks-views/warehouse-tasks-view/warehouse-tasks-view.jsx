...
class WarehouseTasksViewRaw extends Component {
  ...
  render() {
    const {onClickVacantTask, onClickMyTasks, onClickCompletedTasks, onClickCanceledTasks} = this.viewModel
        ...
        <MainContent>
          <div>
            ...
            <div className={classNames.btnsWrapper}>
              ...
              <Button className={classNames.button} color="primary" variant="outlined" onClick={onClickCompletedTasks}>
                <div className={classNames.btnTextWrapper}>
              ...
              <Button className={classNames.button} color="primary" variant="outlined" onClick={onClickCanceledTasks}>
                <div className={classNames.btnTextWrapper}>
