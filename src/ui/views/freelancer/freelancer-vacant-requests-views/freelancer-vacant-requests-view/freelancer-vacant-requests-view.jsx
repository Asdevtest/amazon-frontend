...
import {FreelancerVacantRequestsViewModel} from './freelancer-vacant-requests-view.model'
import {styles} from './freelancer-vacant-requests-view.style'
...
@observer
class FreelancerVacantRequestsViewRaw extends Component {
  viewModel = new FreelancerVacantRequestsViewModel({history: this.props.history})
...
export const FreelancerVacantRequestsView = withStyles(styles)(FreelancerVacantRequestsViewRaw)
