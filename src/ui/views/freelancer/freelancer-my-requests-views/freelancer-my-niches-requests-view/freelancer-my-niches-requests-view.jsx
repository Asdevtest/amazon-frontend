...
import {FreelancerMyNichesRequestsViewModel} from './freelancer-my-niches-requests-view.model'
import {styles} from './freelancer-my-niches-requests-view.style'
...
@observer
class FreelancerMyNichesRequestsViewRaw extends Component {
  viewModel = new FreelancerMyNichesRequestsViewModel({history: this.props.history})
...
export const FreelancerMyNichesRequestsView = withStyles(styles)(FreelancerMyNichesRequestsViewRaw)
