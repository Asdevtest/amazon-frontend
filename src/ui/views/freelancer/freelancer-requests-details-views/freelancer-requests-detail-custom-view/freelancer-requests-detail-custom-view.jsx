...
import {FreelancerRequestDetailCustomViewModel} from './freelancer-requests-detail-custom-view.model'
import {styles} from './freelancer-requests-detail-custom-view.style'
...
@observer
export class FreelancerRequestDetailCustomViewRaw extends Component {
  viewModel = new FreelancerRequestDetailCustomViewModel({
...
export const FreelancerRequestDetailCustomView = withStyles(styles)(FreelancerRequestDetailCustomViewRaw)
