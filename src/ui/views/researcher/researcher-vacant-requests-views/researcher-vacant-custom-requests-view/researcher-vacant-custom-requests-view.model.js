...
export class ResearcherVacantCustomRequestsViewModel {
  history = undefined
  ...
  setDataGridState(state) {
    ...
    SettingsModel.setDataGridState(requestState, DataGridTablesKeys.RESEARCHER_CUSTOM_VACANT_REQUESTS)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.RESEARCHER_CUSTOM_VACANT_REQUESTS]
