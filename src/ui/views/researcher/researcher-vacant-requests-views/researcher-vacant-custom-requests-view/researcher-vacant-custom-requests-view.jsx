...
@observer
class ResearcherVacantCustomRequestsViewRaw extends Component {
  viewModel = new ResearcherVacantCustomRequestsViewModel({history: this.props.history})
...
export const ResearcherVacantCustomRequestsView = withStyles(styles)(ResearcherVacantCustomRequestsViewRaw)
