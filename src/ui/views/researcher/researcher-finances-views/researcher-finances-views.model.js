...
export class ResearcherFinancesViewsModel {
  history = undefined
  ...
  activeSubCategory = SettingsModel.activeSubCategoryState[ActiveSubCategoryTablesKeys.RESEARCHER_FINANCES] || 0
  drawerOpen = false
  ...
  columnsModel = researcherFinancesViewColumns()
  ...
  setActiveSubCategoryState(state) {
    SettingsModel.setActiveSubCategoryState(state, ActiveSubCategoryTablesKeys.RESEARCHER_FINANCES)
  }
  ...
  setDataGridState(state) {
    ...
    SettingsModel.setDataGridState(requestState, DataGridTablesKeys.RESEARCHER_FINANCES)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.RESEARCHER_FINANCES]
    ...
    if (state) {
      ...
      this.columnsModel = researcherFinancesViewColumns().map(el => ({
        ...el,
