...
const textConsts = getLocalizedTexts(texts, 'ru').researcherFinancesView

const navbarActiveCategory = navBarActiveCategory.NAVBAR_FINANCES

@observer
class ResearcherFinancesViewsRaw extends Component {
  viewModel = new ResearcherFinancesViewsModel({history: this.props.history})
...
export const ResearcherFinancesViews = withStyles(styles)(ResearcherFinancesViewsRaw)
