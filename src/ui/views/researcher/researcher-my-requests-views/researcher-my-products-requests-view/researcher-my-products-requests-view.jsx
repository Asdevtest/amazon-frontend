...
import {styles} from './researcher-my-products-requests-view.style'
...
@observer
class ResearcherMyProductsRequestsViewRaw extends Component {
  viewModel = new ResearcherMyProductsRequestsViewModel({history: this.props.history})
...
export const ResearcherMyProductsRequestsView = withStyles(styles)(ResearcherMyProductsRequestsViewRaw)
