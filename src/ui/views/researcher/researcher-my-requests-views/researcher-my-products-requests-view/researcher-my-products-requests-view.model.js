...
export class ResearcherMyProductsRequestsViewModel {
  history = undefined
  ...
  setDataGridState(state) {
    ...
    SettingsModel.setDataGridState(requestState, DataGridTablesKeys.RESEARCHER_PRODUCT_MY_REQUESTS)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.RESEARCHER_PRODUCT_MY_REQUESTS]
