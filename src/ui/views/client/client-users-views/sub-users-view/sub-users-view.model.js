...
export class ClientSubUsersViewModel {
  ...
  setDataGridState(state) {
    ...
    SettingsModel.setDataGridState(requestState, DataGridTablesKeys.CLIENT_SUB_USERS)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.CLIENT_SUB_USERS]
  ...
  async getGroupPermissions() {
    try {
      const result = await PermissionsModel.getGroupPermissions(mapUserRoleEnumToKey[UserRole.CLIENT])
  ...
  async getSinglePermissions() {
    try {
      const result = await PermissionsModel.getSinglePermissions(mapUserRoleEnumToKey[UserRole.CLIENT])
