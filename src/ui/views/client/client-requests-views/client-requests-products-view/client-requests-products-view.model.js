...
export class ClientRequestsProductsViewModel {
  history = undefined
  ...
  setDataGridState(state) {
    SettingsModel.setDataGridState(state, DataGridTablesKeys.CLIENT_PRODUCT_SEARCH_REQUESTS)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.CLIENT_PRODUCT_SEARCH_REQUESTS]
  ...
  onClickTableRow(item) {
    ...
    this.history.push('/client/product-search-request', {request: toJS(requestItem)})
  }
