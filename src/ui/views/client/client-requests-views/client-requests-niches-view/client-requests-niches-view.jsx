...
import {ClientRequestsNichesViewModel} from './client-requests-niches-view.model'
import {styles} from './client-requests-niches-view.style'
...
@observer
class ClientRequestsNichesViewRaw extends Component {
  viewModel = new ClientRequestsNichesViewModel({history: this.props.history})
...
export const ClientRequestsNichesView = withStyles(styles)(ClientRequestsNichesViewRaw)
