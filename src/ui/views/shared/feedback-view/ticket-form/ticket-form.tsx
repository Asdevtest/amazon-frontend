...
export const TicketForm: FC<TicketFormProps> = observer(props => {
  ...
  return (
    <div className={styles.root}>
        ...
        <div className={cx(styles.block, styles.user)}>
          <div className={styles.flexRow}>
            ...
            <div className={styles.flexRow}>
              ...
              />
              prep id <Text type="secondary" text={`ID: ${viewModel.feedback?.xid}`} className={styles.text} />
            </div>
          </div>
      ...
      <div className={cx(styles.flexRow, { [styles.flexEnd]: !viewModel.showUploadButton })}>
