...
import {ActiveOrders} from '@components/buyer/users-views/user-profile-view/active-orders'
import {ContentModal} from '@components/buyer/users-views/user-profile-view/content-modal'
import {Header} from '@components/buyer/users-views/user-profile-view/header'
import {PurchaseHistory} from '@components/buyer/users-views/user-profile-view/purchase-history'
import {Reviews} from '@components/buyer/users-views/user-profile-view/reviews'
