...
export class BuyerSubUsersViewModel {
  ...
  setDataGridState(state) {
    ...
    SettingsModel.setDataGridState(requestState, DataGridTablesKeys.BUYER_SUB_USERS)
  }

  getDataGridState() {
    const state = SettingsModel.dataGridState[DataGridTablesKeys.BUYER_SUB_USERS]
  ...
  async getGroupPermissions() {
    try {
      const result = await PermissionsModel.getGroupPermissions(mapUserRoleEnumToKey[UserRole.BUYER])
  ...
  async getSinglePermissions() {
    try {
      const result = await PermissionsModel.getSinglePermissions(mapUserRoleEnumToKey[UserRole.BUYER])
