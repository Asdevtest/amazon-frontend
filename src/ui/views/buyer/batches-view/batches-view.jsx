...
import {
  BUYER_BATCHES_BOXES_EXAMPLES,
  BUYER_BATCHES_HEAD_CELLS,
...
import {EditBatchModal} from '@components/buyer/batches-view/edit-batch-modal'
import {Main} from '@components/main'
import {MainContent} from '@components/main-content'
import {Modal} from '@components/modal'
import {Navbar} from '@components/navbar'
import {Table} from '@components/table'
import {TableBodyRow} from '@components/table-rows/buyer/batches-view/table-body-row'
import {TableHeadRow} from '@components/table-rows/buyer/batches-view/table-head-row'
...
const textConsts = getLocalizedTexts(texts, 'ru').batchesView
...
class BatchesViewRaw extends Component {
    ...
    return (
      <React.Fragment>
          ...
          >
            <MainContent>
              ...
              <Table
                ...
                data={BUYER_BATCHES_BOXES_EXAMPLES}
                handlerPageChange={this.onChangePagination}
                handlerRowsPerPage={this.onChangeRowsPerPage}
                pageCount={Math.ceil(BUYER_BATCHES_BOXES_EXAMPLES.length / this.state.rowsPerPage)}
        ...
        <Modal openModal={this.state.modalEditBoxes} setOpenModal={this.onChangeModalEditBoxes}>
          <EditBatchModal
            batch={[[BUYER_BATCHES_BOXES_EXAMPLES]]}
  ...
  renderHeadRow = () => <TableHeadRow headCells={BUYER_BATCHES_HEAD_CELLS} />
