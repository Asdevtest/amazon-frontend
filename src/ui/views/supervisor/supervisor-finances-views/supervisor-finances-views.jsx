...
import {styles} from './supervisor-finances-views.style'

const textConsts = getLocalizedTexts(texts, 'ru').supervisorFinancesView

const navbarActiveCategory = navBarActiveCategory.NAVBAR_FINANCES

@observer
class SupervisorFinancesViewsRaw extends Component {
  viewModel = new SupervisorFinancesViewsModel({history: this.props.history})
...
export const SupervisorFinancesViews = withStyles(styles)(SupervisorFinancesViewsRaw)
