...
import {useClassNames} from './niche-search-request-form.style'
...
export const NicheSearchRequestForm = ({onSubmit, setOpenModal, isEdit, requestToEdit}) => {
  ...
  const sourceFormFields = {
    ...
    denyNichesBoughtByMe: requestToEdit?.denyNichesBoughtByMe || false,
  }
  ...
  const onChangeField = fieldName => event => {
    ...
    if (numberFields.includes(fieldName) && !checkIsPositiveNummberAndNoMoreTwoCharactersAfterDot(event.target.value)) {
      return
    } else if (['denyNichesBoughtByMe'].includes(fieldName)) {
    ...
    <div className={classNames.root}>
      <div className={classNames.form}>
        ...
        <div className={classNames.checkboxWrapper}>
          <Checkbox
            color="primary"
            checked={formFields.denyNichesBoughtByMe}
            onChange={onChangeField('denyNichesBoughtByMe')}
          />
          <Typography>{textConsts.formCheckboxNoPurchasedNiches}</Typography>
        </div>
      </div>
