...
import {DatePickerTime} from '@components/date-picker/date-picker'
    ...
    <div className={classNames.root}>
      ...
      <div className={classNames.reasonInputWrapper}>
        <Field
          ...
          minRows={6}
          label={t(TranslationKey['Describe the reason for the rework'])}
      ...
      <div className={classNames.inputsWrapper}>
        <div className={classNames.inputWrapper}>
          <Field
            ...
            onChange={(event: ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => onChangeHour(event.target.value)}
          />
