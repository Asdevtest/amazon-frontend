...
import { ApiV1BatchesBoxes, InlineResponse20024 } from '@services/rest-api-service/codegen'
...
export class BoxesToOrderTabModel {
  ...
  currentBox: InlineResponse20024 | undefined = undefined
  ...
  async onSubmitChangeBoxFields(box: InlineResponse20024) {
    try {
