...
export const SearchResult = observer(({curFoundedMessageIndex, messagesFound, onClose, onChangeCurFoundedMessage}) => {
    ...
    <div className={classNames.searchResultWrapper}>
      ...
      <div className={classNames.dropUpOrDownWrapper}>
        ...
        <ArrowDropDownIcon
          ...
          onClick={() =>
            curFoundedMessageIndex + 1 !== messagesFound.length && onChangeCurFoundedMessage(curFoundedMessageIndex + 1)
          }
        />
      </div>
