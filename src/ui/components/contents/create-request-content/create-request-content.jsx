...
import {useClassNames} from './create-request-content.style'

// const textConsts = getLocalizedTexts(texts, 'ru').CreateRequestContent
...
export const CreateRequestContent = ({history, onSubmit}) => {
  ...
  const sourceFormFields = {
    ...
    details: {
      name: 'null', // пока на беке не убрали, чтобы тестить
      conditions: '',
      linksToMediaFiles: [],
    },
  }
