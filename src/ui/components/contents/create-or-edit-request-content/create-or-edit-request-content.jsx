...
export const CreateOrEditRequestContent = observer(
  ({
    announcements,
    permissionsData,
    masterUsersData,
                      ...
                      inputComponent={
                        ...
                        >
                          ...
                          {Object.keys(freelanceRequestTypeByCode)
                            .filter(
                              el => String(el) !== String(freelanceRequestTypeByKey[freelanceRequestType.DEFAULT]),
                            )
                          ...
                          <div className={classNames.infoColumn}>
                            <Field
                              ...
                              inputComponent={
                                <Typography className={classNames.twoStepFieldResult}>
                                  {freelanceRequestTypeTranslate(
                                    freelanceRequestTypeByCode[formFields.request.typeTask],
                                  )}
                                </Typography>
                              }
                            />
                          ...
                          {formFields.request.withoutConfirmation && (
                            <div className={classNames.selectedCheckbox}>
                              ...
                              <Typography className={classNames.restrictMoreThanOneProposal}>
                                {t(
                                  TranslationKey[
                                    'Allow the performer to take the request for work without confirmation'
                                  ],
                                )}
                              </Typography>
                            </div>
          ...
          <div className={classNames.stepPagination}>
            ...
            <div className={classNames.stepPaginationBar}>
              <div
                ...
                style={{ width: curStep === stepVariant.STEP_ONE ? '50%' : '100%' }}
              ></div>
            </div>
            <div
