...
export const WarehouseHistory = observer(({title, tasksData, onClickTaskInfo, onClickCancelBtn}) => {
        ...
        <Table className={classNames.table}>
          <TableHead>
            <TableRow>
              ...
              <TableCell className={classNames.centerTextCell}>{textConsts.updatedAt}</TableCell>
