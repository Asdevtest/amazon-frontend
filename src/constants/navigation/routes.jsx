...
export const privateRoutesConfigs = [
...

  {
    ...
    exact: false,
    permission: [Roles[Roles.RESEARCHER]],
...

  {
    ...
    exact: false,
    permission: [Roles[Roles.SUPERVISOR]],
...

  {
    ...
    exact: false,
    permission: [Roles[Roles.STOREKEEPER]],
...

  {
    ...
    exact: false,
    permission: [Roles[Roles.FREELANCER]],
