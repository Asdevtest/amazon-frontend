...
export enum TranslationKey {
  ...
  'Batches are expected' = 'Batches are expected',
  'Batches in the works' = 'Batches in the works',
  'Batches at the checkout' = 'Batches at the checkout',
  'The batches accepted' = 'The batches accepted',
