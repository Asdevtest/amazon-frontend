export enum TranslationKey {
  ...
  'Opens the form to Create request' = 'Opens the form to Create request',
  ...
  'Create request to send to the batch, freeze funds, then see "My batches"' = 'Create request to send to the batch, freeze funds, then see "My batches"',
