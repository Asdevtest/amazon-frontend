...
import { disableSelectionCells } from '@views/client/client-warehouse-views/client-in-stock-boxes-view/client-in-stock-boxes-view.constants'
...
import { ClientInventoryModel, TAGS, clickableCells, disableDoubleClickOnCells } from '../../model'
import { Header } from '../header'

import classes from './styles.module.scss'

export const ClientInventoryPage = observer(() => {
  const [viewModel] = useState(() => new ClientInventoryModel())
  ...
  const getCellClassName = params => clickableCells.includes(params.field) && classes.clickableCell
